...
class SetupProctoringEventListeners extends InstallAction
{
    public function __invoke($params)
    {
        ...
        $this->registerEvent(DeliveryExecutionFinished::class, [LoggerService::class, 'logEvent']);

        /**
         * Need to check http://www.tao.lu/Ontologies/TAODelivery.rdf#ProctorAccessible for every action and setting
         * correct value.
         */
        ...
        $this->registerEvent(
            DeliveryExecutionTimerAdjusted::class,
            [DeliveryLogTimerAdjustedEventListener::class, 'logTimeAdjustment']
        );
    }
}
