...
}},{id:"back",icon:"preview",title:__("Return to the session monitoring"),label:__("Monitoring"),action:function(){location.href=monitoringUrl}},{id:"assign",icon:"add",title:__("Assign more test takers to this session"),label:__("Add test takers"),action:function(){location.href=assignUrl}},{id:"remove",icon:"remove",title:__("Remove the selected test takers from the session"),label:__("Remove"),massAction:!0,action:function(selection){dialog({message:__("The test takers will be removed from this session. Continue ?"),autoRender:!0,autoDestroy:!0,onOkBtn:function(){remove(selection)}})}}],actions:[{id:"remove",icon:"remove",title:__("Remove the test taker from the session"),action:function(id){dialog({autoRender:!0,autoDestroy:!0,message:__("The test taker will be removed from this session. Continue ?"),onOkBtn:function(){remove([id])
}})}}],selectable:!0,model:[{id:"firstname",label:__("First name")},{id:"lastname",label:__("Last name")},{id:"identifier",label:__("Identifier")},{id:"status",label:__("Status")}]},dataset)}};return proctorDeliveryIndexCtlr}),define("tpl!taoProctoring/templates/delivery/itemProgress",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){function program1(depth0,data){var stack1,buffer="";return buffer+="\n    ",stack1=helpers["if"].call(depth0,depth0&&depth0.position,{hash:{},inverse:self.noop,fn:self.program(2,program2,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n    ",stack1=helpers["if"].call(depth0,depth0&&depth0.label,{hash:{},inverse:self.noop,fn:self.program(5,program5,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n"
}function program2(depth0,data){var stack1,helper,options,buffer="";return buffer+='<span class="state section-progress">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"section",options):helperMissing.call(depth0,"__","section",options)))+" ",(helper=helpers.position)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.position,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1),stack1=helpers["if"].call(depth0,depth0&&depth0.total,{hash:{},inverse:self.noop,fn:self.program(3,program3,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="</span>"
}function program3(depth0,data){var stack1,helper,buffer="";return buffer+="/",(helper=helpers.total)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.total,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)}function program5(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="state section-label">',(helper=helpers.label)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.label,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+"</span>"}function program7(depth0,data){var stack1,buffer="";
return buffer+="\n    ",stack1=helpers["if"].call(depth0,depth0&&depth0.position,{hash:{},inverse:self.noop,fn:self.program(8,program8,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n    ",stack1=helpers["with"].call(depth0,depth0&&depth0.time,{hash:{},inverse:self.noop,fn:self.program(10,program10,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n"}function program8(depth0,data){var stack1,helper,options,buffer="";return buffer+='<span class="state item-progress">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"item",options):helperMissing.call(depth0,"__","item",options)))+" ",(helper=helpers.position)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.position,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1),stack1=helpers["if"].call(depth0,depth0&&depth0.total,{hash:{},inverse:self.noop,fn:self.program(3,program3,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="</span>"
...
}function program12(depth0,data){var stack1,helper,options,buffer="";return buffer+='<span class="elapsed" title="'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Elapsed time",options):helperMissing.call(depth0,"__","Elapsed time",options)))+'">',(helper=helpers.elapsedStr)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.elapsedStr,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+"</span>"}function program14(depth0,data){var stack1,helper,options,buffer="";return buffer+='<span class="total" title="'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Total time",options):helperMissing.call(depth0,"__","Total time",options)))+'">',(helper=helpers.totalStr)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.totalStr,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+"</span>"
}this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing,self=this;return buffer+='<span class="progress">\n',stack1=helpers["with"].call(depth0,depth0&&depth0.section,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n",stack1=helpers["with"].call(depth0,depth0&&depth0.item,{hash:{},inverse:self.noop,fn:self.program(7,program7,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\n</span>"})}),define("tpl!taoProctoring/templates/delivery/deliveryLink",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};
...
this._strategies=[],_.forEach(newStrategies,function(strategy){_.isPlainObject(strategy)?assetManager.addStrategy(strategy):_.isFunction(strategy)&&self.addStrategy({name:"strategy_"+(self._strategies.length+1),handle:strategy})})},setData:function(key,value){_.isString(key)&&"undefined"!=typeof value?data[key]=value:_.isPlainObject(key)&&(data=key)},getData:function(key){return _.isString(key)?data[key]:data},resolve:function(url){var resolved,inputUrl;return options.cache&&cache.hasOwnProperty(url)?cache[url]:(inputUrl=options.parseUrl?urlUtil.parse(url):url,_.forEach(this._strategies,function(strategy){var result=strategy.handle(inputUrl,data);return result?(resolved=result,!1):void 0
...
}},external:{name:"external",handle:function(url){return urlUtil.isAbsolute(url)?url.toString():void 0}},base64:{name:"base64",handle:function(url){return urlUtil.isBase64(url)?url.toString():void 0}},taomedia:{name:"taomedia",handle:function(url,data){var baseUrl=data.baseUrl||"./";return"object"==typeof url&&"taomedia"===url.protocol||/^taomedia:\/\//.test(url.toString())?baseUrl+url.toString():void 0}}};return strategies}),define("taoQtiItem/qtiCommonRenderer/renderers/config",["lodash","context","ui/themes","taoItems/assets/manager","taoItems/assets/strategies"],function(_,context,themes,assetManagerFactory,assetStrategies){"use strict";var itemThemes=themes.get("items"),portableAssetStrategy={name:"portableElementLocation",handle:function(url){return url.source===url.relative?window.location.pathname.replace(/([^\/]*)$/,"")+url.toString()+"/":void 0
...
return{name:"commonRenderer",locations:locations,options:{assetManager:assetManager,themes:itemThemes}}}),define("taoQtiItem/qtiCommonRenderer/renderers/Renderer",["taoQtiItem/qtiRunner/core/Renderer","taoQtiItem/qtiCommonRenderer/renderers/config"],function(Renderer,config){"use strict";return Renderer.build(config.locations,config.name,config.options)}),define("taoClientDiagnostic/tools/performances/tester",["jquery","lodash","async","context","helpers","taoClientDiagnostic/tools/stats","taoQtiItem/qtiItem/core/Loader","taoQtiItem/qtiCommonRenderer/renderers/Renderer","lib/polyfill/performance-now"],function($,_,async,context,helpers,stats,Loader,Renderer){"use strict";
function loadItem(data,done){var qtiJsonFile=data.url+"qti.json",urlTokens=data.url.split("/"),extension=urlTokens[0],fullpath=require.s.contexts._.config.paths[extension],baseUrl=data.url.replace(extension,fullpath),loader=new Loader,renderer=new Renderer({baseUrl:baseUrl});renderer.getAssetManager&&renderer.getAssetManager().setData("baseUrl",baseUrl),require(["json!"+qtiJsonFile],function(itemData){loader.loadItemData(itemData,function(item){renderer.load(function(){var $container,duration,start,end,result;start=window.performance.now(),item.setRenderer(this),$container=$("<div>").appendTo("body"),$container.append(item.render()),item.postRender(),$container.remove(),end=window.performance.now(),duration=(end-start)/_second,result={id:data.id,url:data.url,duration:duration},done(null,result)
},this.getLoadedClasses())})})}var _second=1e3,_defaultTimeout=30*_second,_defaultOccurrencesCount=10,_defaultSamples=["taoClientDiagnostic/tools/performances/data/sample1/","taoClientDiagnostic/tools/performances/data/sample2/","taoClientDiagnostic/tools/performances/data/sample3/"],_sampleBaseId="sample",performancesTester=function(samples,occurrences,timeout){var idx=0,_samples=_.map(!_.isEmpty(samples)&&samples||_defaultSamples,function(sample){return idx++,{id:_sampleBaseId+idx,url:sample,timeout:timeout||_defaultTimeout,nb:occurrences||_defaultOccurrencesCount}});return _samples[0].nb++,{start:function(done){var tests=[];_.forEach(_samples,function(data){for(var cb=_.partial(loadItem,data),iterations=data.nb||1;iterations--;)tests.push(cb)
}),async.series(tests,function(err,measures){var results,decimals=2;if(err&&!measures.length)throw err;measures.shift(),results=stats(measures,"duration",decimals),done(results.average,results)})}}};return performancesTester}),define("taoClientDiagnostic/tools/bandwidth/tester",["lodash","async","context","taoClientDiagnostic/tools/stats","taoClientDiagnostic/tools/fixedDecimals","lib/polyfill/performance-now"],function(_,async,context,stats,fixedDecimals){"use strict";var _kilo=1024,_mega=_kilo*_kilo,_second=1e3,_downloadData={"10KB":{id:"10KB",file:"data/bin10KB.data",size:10*_kilo,timeout:_second,threshold:0,nb:10},"100KB":{id:"100KB",file:"data/bin100KB.data",size:100*_kilo,timeout:2*_second,threshold:0,nb:5},"1MB":{id:"1MB",file:"data/bin1MB.data",size:_mega,timeout:20*_second,threshold:0,nb:3},"10MB":{id:"10MB",file:"data/bin10MB.data",size:10*_mega,timeout:20*_second,threshold:8,nb:3}},download=function(data,cb){var start,end,timeoutId,url,request,self=this;
...
})}),define("taoProctoring/controller/Diagnostic/diagnostic",["jquery","i18n","helpers","layout/loading-bar","ui/actionbar","ui/feedback","taoProctoring/component/breadcrumbs","taoClientDiagnostic/tools/diagnostic/diagnostic","tpl!taoProctoring/templates/diagnostic/main"],function($,__,helpers,loadingBar,actionbar,feedback,breadcrumbsFactory,diagnosticFactory,diagnosticTpl){"use strict";var cssScope=".diagnostic-runner";loadingBar.start();var taoProctoringDiagnosticRunnerCtlr={start:function(){function installTester(workstation){diagnosticFactory(config).setTemplate(diagnosticTpl).on("render",function(){var self=this;this.controls.$workstation=this.getElement().find('[data-control="workstation"]').on("keypress",function(e){13===e.which&&(e.preventDefault(),self.run())
}).val(workstation)}).on("start",function(){this.config.storeParams=this.config.storeParams||{},this.config.storeParams.workstation=this.controls.$workstation.val(),this.controls.$workstation.prop("disabled",!0),loadingBar.start()}).on("end",function(){this.controls.$workstation.removeProp("disabled"),loadingBar.stop()}).on("render",function(){loadingBar.stop()}).render($list)}{var $container=$(cssScope),$list=$container.find(".list"),$panel=$(".panel"),crumbs=$container.data("breadcrumbs"),config=$container.data("config"),testCenterId=$container.data("testcenter"),indexUrl=helpers._url("index","Diagnostic","taoProctoring",{testCenter:testCenterId}),workstationUrl=helpers._url("workstation","DiagnosticChecker","taoProctoring",{testCenter:testCenterId});
breadcrumbsFactory($container,crumbs)}actionbar({renderTo:$panel,buttons:[{id:"back",icon:"step-backward",title:__("Return to the list"),label:__("List of readiness checks"),action:function(){location.href=indexUrl}}]}),$.get(workstationUrl,"json").done(function(data){installTester(data&&data.workstation)}).fail(function(){feedback().error(__("Unable to get the workstation name!")),installTester()})}};return taoProctoringDiagnosticRunnerCtlr}),define("taoProctoring/controller/Diagnostic/index",["jquery","i18n","helpers","layout/loading-bar","util/encode","ui/feedback","ui/dialog","taoProctoring/component/breadcrumbs","taoClientDiagnostic/tools/diagnostic/status","ui/datatable"],function($,__,helpers,loadingBar,encode,feedback,dialog,breadcrumbsFactory,statusFactory){"use strict";
function formatNumber(number,digits){var nb=void 0===digits?2:Math.max(0,parseInt(digits,10)),factor=Math.pow(10,nb)||1;return Math.round(number*factor)/factor}var cssScope=".diagnostic-index";loadingBar.start();var taoProctoringDiagnosticCtlr={start:function(){function request(url,selection,message){selection&&selection.length&&(loadingBar.start(),$.ajax({url:url,data:{id:selection},dataType:"json",type:"POST",error:function(){loadingBar.stop()}}).done(function(response){loadingBar.stop(),response&&response.success?(message&&feedback().success(message),$list.datatable("refresh")):feedback().error(__("Something went wrong ...")+"<br>"+encode.html(response.error),{encodeHtml:!1})
}))}function remove(selection){request(removeUrl,selection,__("The readiness check result have been removed"))}var $container=$(cssScope),$list=$container.find(".list"),crumbs=$container.data("breadcrumbs"),dataset=$container.data("set"),config=$container.data("config")||{},testCenterId=$container.data("testcenter"),diagnosticUrl=helpers._url("diagnostic","Diagnostic","taoProctoring",{testCenter:testCenterId}),removeUrl=helpers._url("remove","Diagnostic","taoProctoring",{testCenter:testCenterId}),serviceUrl=helpers._url("diagnosticData","Diagnostic","taoProctoring",{testCenter:testCenterId}),performancesConfig=config.performances||{},performancesOptimal=performancesConfig.optimal,performancesRange=Math.abs(performancesOptimal-performancesConfig.threshold),diagnosticStatus=statusFactory(),tools=(breadcrumbsFactory($container,crumbs),[]),actions=[],model=[];
tools.push({id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){$list.datatable("refresh")}}),tools.push({id:"launch",icon:"play",title:__("Launch another readiness check"),label:__("Launch readiness check"),action:function(){location.href=diagnosticUrl}}),tools.push({id:"remove",icon:"remove",title:__("Remove the selected readiness check results"),label:__("Remove"),massAction:!0,action:function(selection){dialog({message:__("The selected readiness check results will be removed. Continue ?"),autoRender:!0,autoDestroy:!0,onOkBtn:function(){remove(selection)}})}}),actions.push({id:"remove",icon:"remove",title:__("Remove the readiness check result?"),action:function(id){dialog({autoRender:!0,autoDestroy:!0,message:__("The readiness check result will be removed. Continue ?"),onOkBtn:function(){remove([id])
