...
}},external:{name:"external",handle:function(url,data){return urlUtil.isAbsolute(url)?url.toString():void 0}},base64:{name:"base64",handle:function(url){return urlUtil.isBase64(url)?url.toString():void 0}},taomedia:{name:"taomedia",handle:function(url,data){var baseUrl=data.baseUrl||"./";return"object"==typeof url&&"taomedia"===url.protocol||/^taomedia:\/\//.test(url.toString())?baseUrl+url.toString():void 0}}};return strategies}),define("taoQtiItem/qtiCommonRenderer/renderers/config",["lodash","context","ui/themes","taoItems/assets/manager","taoItems/assets/strategies","module"],function(_,context,themes,assetManagerFactory,assetStrategies,module){"use strict";
var itemThemes=themes.get("items"),moduleConfig=module.config(),portableAssetStrategy={name:"portableElementLocation",handle:function(url){return url.source===url.relative?window.location.pathname.replace(/([^\/]*)$/,"")+url.toString()+"/":void 0}},assetManager=assetManagerFactory([{name:"theme",handle:function(url){return itemThemes&&url.path&&(url.path===itemThemes.base||_.contains(_.pluck(itemThemes.available,"path"),url.path))?context.root_url+url.toString():void 0}},assetStrategies.taomedia,assetStrategies.external,assetStrategies.base64,assetStrategies.baseUrl,portableAssetStrategy],{baseUrl:""}),locations={assessmentItem:"taoQtiItem/qtiCommonRenderer/renderers/Item",
_container:"taoQtiItem/qtiCommonRenderer/renderers/Container",_simpleFeedbackRule:!1,stylesheet:"taoQtiItem/qtiCommonRenderer/renderers/Stylesheet",outcomeDeclaration:!1,responseDeclaration:!1,responseProcessing:!1,img:"taoQtiItem/qtiCommonRenderer/renderers/Img",math:"taoQtiItem/qtiCommonRenderer/renderers/Math",object:"taoQtiItem/qtiCommonRenderer/renderers/Object",rubricBlock:"taoQtiItem/qtiCommonRenderer/renderers/RubricBlock",modalFeedback:"taoQtiItem/qtiCommonRenderer/renderers/ModalFeedback",prompt:"taoQtiItem/qtiCommonRenderer/renderers/interactions/Prompt",choiceInteraction:"taoQtiItem/qtiCommonRenderer/renderers/interactions/ChoiceInteraction",extendedTextInteraction:"taoQtiItem/qtiCommonRenderer/renderers/interactions/ExtendedTextInteraction",
...
[]),actions=[],model=[];tools.push({id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){$list.datatable("refresh")}}),tools.push({id:"launch",icon:"play",title:__("Launch another readiness check"),label:__("Launch readiness check"),action:function(){window.location.href=diagnosticUrl}}),tools.push({id:"remove",icon:"remove",title:__("Remove the selected readiness check results"),label:__("Remove"),massAction:!0,action:function(selection){dialog({message:__("The selected readiness check results will be removed. Continue ?"),autoRender:!0,autoDestroy:!0,onOkBtn:function(){remove(selection)}})}}),actions.push({id:"remove",
icon:"remove",title:__("Remove the readiness check result?"),action:function(id){dialog({autoRender:!0,autoDestroy:!0,message:__("The readiness check result will be removed. Continue ?"),onOkBtn:function(){remove([id])}})}}),model.push({id:"workstation",label:__("Workstation")}),model.push({id:"os",label:__("OS")}),model.push({id:"browser",label:__("Browser")}),model.push({id:"performance",label:__("Performances"),transform:function(value){var cursor=performancesRange-value+performancesOptimal,status=diagnosticStatus.getStatus(cursor/performancesRange*100,"performances");return status.feedback.message}}),model.push({id:"bandwidth",label:__("Bandwidth"),transform:function(value){
