...
}}),_.each(extraFields,function(extraField){model.push({id:extraField.id,label:extraField.label,sortable:!0,transform:function(value,row){return row&&row.extraFields&&row.extraFields[extraField.id]||""}})}),model.push({id:"start_time",sortable:!0,label:__("Started at"),filterable:!0,transform:function(value){return locale.formatDateTime(value)},filterTransform:function(value){var values=value.split(" - "),result="";return values[0]&&(result=moment(values[0],"YYYY/MM/DD").format("X")),values[1]&&(values[1]=moment(values[1],"YYYY/MM/DD").add(1,"d").format("X"),""!==result&&(result+=" - "),result+=values[1]),result},customFilter:{template:'<input type="text" id="start_time_filter" name="filter[start_time]"/><button class="icon-find js-start_time_filter_button" type="button"></button>',
callback:function($el){$el.datepicker({dateFormat:"yy/mm/dd",onSelect:function(selectedDate){$(this).data().datepicker.first?(selectedDate>$(this).data().datepicker.first?$(this).val($(this).data().datepicker.first+" - "+selectedDate):$(this).val(selectedDate+" - "+$(this).data().datepicker.first),$(this).data().datepicker.inline=!1,$(".js-start_time_filter_button").trigger("click")):($(this).data().datepicker.inline=!0,$(this).data().datepicker.first=selectedDate)},onClose:function(){delete $(this).data().datepicker.first,$(this).data().datepicker.inline=!1}})}}}),model.push({id:"status",label:__("Status"),sortable:!0,filterable:!0,customFilter:{template:buildStatusFilter(),
