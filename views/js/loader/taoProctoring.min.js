...
"taoProctoring/controller/DeliveryServer/awaiting",["lodash","jquery","i18n","helpers","layout/loading-bar","ui/listbox","ui/dialog/alert","core/polling","taoQtiTest/testRunner/resumingStrategy/keepAfterResume","util/url","ui/dialog/confirm","tpl!taoProctoring/templates/deliveryServer/authorizationSuccess","tpl!taoProctoring/templates/deliveryServer/authorizationListBoxActions"],function(_,$,__,helpers,loadingBar,listBox,dialogAlert,polling,keepAfterResume,url,dialogConfirm,authSuccessTpl,listBoxActionsTpl){"use strict";return{start:function(config){var $container=$(".awaiting-authorization"),isAuthorizedUrl=helpers._url("isAuthorized","DeliveryServer",
"taoProctoring",{deliveryExecution:config.deliveryExecution}),runDeliveryUrl=config.runDeliveryUrl,boxes=[{id:"goToDelivery",label:config.deliveryLabel,url:runDeliveryUrl,content:__("Please wait, authorization in process ..."),html:listBoxActionsTpl({id:config.deliveryExecution,cancelable:config.cancelable})}],$content=(listBox({title:"",textEmpty:"",textNumber:"",textLoading:"",renderTo:$container,list:boxes,width:12}),$container.find(".listbox .content")),deliveryStarted=!1,runDelivery=function(){loadingBar.start(),deliveryStarted=!0,window.location.href=runDeliveryUrl},isRunnable=function(){return!$container.hasClass("authorization-in-progress"
)&&!deliveryStarted};function exit(){window.location.href=config.returnUrl}keepAfterResume().reset(),loadingBar.start(!1),$container.on("click",".js-cancel",function(e){e.stopPropagation(),e.preventDefault(),dialogConfirm(__("Are you sure you want to end the test?"),function(){window.location.href=config.cancelUrl})}),$container.on("click",".js-proceed",function(e){return isRunnable()&&runDelivery(),!1}),$container.on("click",".block.box",function(e){return isRunnable()&&runDelivery(),!1}),polling({action:function(){var async=this.async();$.get(isAuthorizedUrl,function(result){var stop=!1;result.success?result.authorized&&(stop=!0,$content.html(
authSuccessTpl({message:__("Authorized, you may proceed")})),loadingBar.stop(),$container.addClass("authorization-granted").removeClass("authorization-in-progress")):(stop=!0,result.message?dialogAlert(result.message,exit):exit()),stop?async.reject():async.resolve()})},interval:1e4,autoStart:!0}).next()}}}),define("taoProctoring/controller/Irregularity/index",["jquery","lodash","i18n","ui/hider","util/url","ui/feedback","core/taskQueue/taskQueue","ui/taskQueueButton/standardButton"],function($,_,__,hider,urlHelper,feedback,taskQueue,taskCreationButtonFactory){"use strict";return{start:function(){var taskCreationButton,purpose,$header=$(
"header.section-header"),$formContainer=$(".print-form"),$reportContainer=$(".print-report"),$form=$("form",$formContainer),$submitter=$(".form-submitter",$form),$containers=$(".main-container");function refreshTree(){$(".tree").trigger("refresh.taotree",[{uri:$header.data("select-node")}])}purpose="form",hider.hide($containers),hider.show($containers.filter('[data-purpose="'+purpose+'"]')),taskCreationButton=taskCreationButtonFactory({type:"info",icon:"export",title:__("Export Irregularities"),label:__("Export"),taskQueue:taskQueue,taskCreationUrl:$form.prop("action"),taskCreationData:function(){return $form.serializeArray()},
taskReportContainer:$reportContainer}).on("finished",function(result){result.task&&result.task.report&&_.isArray(result.task.report.children)&&result.task.report.children.length&&result.task.report.children[0]&&(result.task.report.children[0].data&&result.task.report.children[0].data.uriResource?(feedback().info(__("%s completed",result.task.taskLabel)),refreshTree(result.task.report.children[0].data.uriResource)):this.displayReport(result.task.report.children[0],__("Error")))}).on("continue",function(){refreshTree()}).on("error",function(err){feedback().error(err)}).render($submitter.closest(".form-toolbar")),$submitter.replaceWith(
taskCreationButton.getElement().css({float:"right"}))}}}),define("tpl!taoProctoring/component/dateRange/form",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<form class="daterange">\r\n    <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"From",options):helperMissing.call(depth0,"__","From",options))
)+'</label><input type="text" name="periodStart" value="',buffer+=escapeExpression((helper=helpers.start)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.start)?helper.call(depth0,{hash:{},data:data}):helper)+'"/>\r\n    <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"to",options):helperMissing.call(depth0,"__","to",options)))+'</label><input type="text" name="periodEnd" value="',buffer+=escapeExpression((helper=helpers.end)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.end)?helper.call(depth0,{hash:{},data:data}):helper
)+'"/>\r\n    <button class="small info" data-control="filter"><span class="icon icon-filter"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Filter",options):helperMissing.call(depth0,"__","Filter",options)))+"</button>\r\n</form>"})}),define("jquery.timePicker",["jquery","jqueryui"],function(jQuery){var $=jQuery;if($.ui.timepicker=$.ui.timepicker||{},!$.ui.timepicker.version){$.extend($.ui,{timepicker:{version:"1.3"}});var Timepicker=function(){this.regional=[],this.regional[""]={currentText:"Now",closeText:"Done",amNames:["AM","A"],pmNames:["PM","P"],timeFormat:"HH:mm",timeSuffix:"",
timeOnlyTitle:"Choose Time",timeText:"Time",hourText:"Hour",minuteText:"Minute",secondText:"Second",millisecText:"Millisecond",microsecText:"Microsecond",timezoneText:"Time Zone",isRTL:!1},this._defaults={showButtonPanel:!0,timeOnly:!1,showHour:null,showMinute:null,showSecond:null,showMillisec:null,showMicrosec:null,showTimezone:null,showTime:!0,stepHour:1,stepMinute:1,stepSecond:1,stepMillisec:1,stepMicrosec:1,hour:0,minute:0,second:0,millisec:0,microsec:0,timezone:null,hourMin:0,minuteMin:0,secondMin:0,millisecMin:0,microsecMin:0,hourMax:23,minuteMax:59,secondMax:59,millisecMax:999,microsecMax:999,minDateTime:null,maxDateTime:null,onSelect:null,hourGrid:0,
minuteGrid:0,secondGrid:0,millisecGrid:0,microsecGrid:0,alwaysSetTime:!0,separator:" ",altFieldTimeOnly:!0,altTimeFormat:null,altSeparator:null,altTimeSuffix:null,pickerTimeFormat:null,pickerTimeSuffix:null,showTimepicker:!0,timezoneList:null,addSliderAccess:!1,sliderAccessArgs:null,controlType:"slider",defaultValue:null,parse:"strict"},$.extend(this._defaults,this.regional[""])};$.extend(Timepicker.prototype,{$input:null,$altInput:null,$timeObj:null,inst:null,hour_slider:null,minute_slider:null,second_slider:null,millisec_slider:null,microsec_slider:null,timezone_select:null,hour:0,minute:0,second:0,millisec:0,microsec:0,timezone:null,hourMinOriginal:null,
minuteMinOriginal:null,secondMinOriginal:null,millisecMinOriginal:null,microsecMinOriginal:null,hourMaxOriginal:null,minuteMaxOriginal:null,secondMaxOriginal:null,millisecMaxOriginal:null,microsecMaxOriginal:null,ampm:"",formattedDate:"",formattedTime:"",formattedDateTime:"",timezoneList:null,units:["hour","minute","second","millisec","microsec"],support:{},control:null,setDefaults:function(settings){return extendRemove(this._defaults,settings||{}),this},_newInst:function($input,o){var tp_inst=new Timepicker,inlineSettings={},fns={},overrides,i;for(var attrName in this._defaults)if(this._defaults.hasOwnProperty(attrName)){var attrValue=$input.attr(
"time:"+attrName);if(attrValue)try{inlineSettings[attrName]=eval(attrValue)}catch(err){inlineSettings[attrName]=attrValue}}for(i in overrides={beforeShow:function(input,dp_inst){if($.isFunction(tp_inst._defaults.evnts.beforeShow))return tp_inst._defaults.evnts.beforeShow.call($input[0],input,dp_inst,tp_inst)},onChangeMonthYear:function(year,month,dp_inst){tp_inst._updateDateTime(dp_inst),$.isFunction(tp_inst._defaults.evnts.onChangeMonthYear)&&tp_inst._defaults.evnts.onChangeMonthYear.call($input[0],year,month,dp_inst,tp_inst)},onClose:function(dateText,dp_inst){!0===tp_inst.timeDefined&&""!==$input.val()&&tp_inst._updateDateTime(dp_inst),$.isFunction(
tp_inst._defaults.evnts.onClose)&&tp_inst._defaults.evnts.onClose.call($input[0],dateText,dp_inst,tp_inst)}},overrides)overrides.hasOwnProperty(i)&&(fns[i]=o[i]||null);tp_inst._defaults=$.extend({},this._defaults,inlineSettings,o,overrides,{evnts:fns,timepicker:tp_inst}),tp_inst.amNames=$.map(tp_inst._defaults.amNames,function(val){return val.toUpperCase()}),tp_inst.pmNames=$.map(tp_inst._defaults.pmNames,function(val){return val.toUpperCase()}),tp_inst.support=detectSupport(tp_inst._defaults.timeFormat+(tp_inst._defaults.pickerTimeFormat?tp_inst._defaults.pickerTimeFormat:"")+(tp_inst._defaults.altTimeFormat?tp_inst._defaults.altTimeFormat:"")),
"string"==typeof tp_inst._defaults.controlType?("slider"==tp_inst._defaults.controlType&&void 0===jQuery.ui.slider&&(tp_inst._defaults.controlType="select"),tp_inst.control=tp_inst._controls[tp_inst._defaults.controlType]):tp_inst.control=tp_inst._defaults.controlType;var timezoneList=[-720,-660,-600,-570,-540,-480,-420,-360,-300,-270,-240,-210,-180,-120,-60,0,60,120,180,210,240,270,300,330,345,360,390,420,480,525,540,570,600,630,660,690,720,765,780,840];null!==tp_inst._defaults.timezoneList&&(timezoneList=tp_inst._defaults.timezoneList);var tzl=timezoneList.length,tzi=0,tzv=null;if(0<tzl&&"object"!=typeof timezoneList[0])for(;tzi<tzl;tzi++
)tzv=timezoneList[tzi],timezoneList[tzi]={value:tzv,label:$.timepicker.timezoneOffsetString(tzv,tp_inst.support.iso8601)};return tp_inst._defaults.timezoneList=timezoneList,tp_inst.timezone=null!==tp_inst._defaults.timezone?$.timepicker.timezoneOffsetNumber(tp_inst._defaults.timezone):-1*(new Date).getTimezoneOffset(),tp_inst.hour=tp_inst._defaults.hour<tp_inst._defaults.hourMin?tp_inst._defaults.hourMin:tp_inst._defaults.hour>tp_inst._defaults.hourMax?tp_inst._defaults.hourMax:tp_inst._defaults.hour,
...
"lodash","ui/component","tpl!taoProctoring/component/dateRange/form","util/locale","jquery.timePicker"],function($,_,component,formTpl,locale){"use strict";var dateFormatStr=locale.getDateTimeFormat().split(" ")[0],_defaults={dateFormat:dateFormatStr=(dateFormatStr=(dateFormatStr=dateFormatStr.replace("YYYY","yy")).replace("MM","mm")).replace("DD","dd")};return function(config){var initConfig=_.defaults(config||{},_defaults),periodStart=initConfig.start||"",periodEnd=initConfig.end||"",dateRange={getStart:function(){return periodStart},getEnd:function(){return periodEnd}};return initConfig.start=periodStart,initConfig.end=periodEnd,component(dateRange
).setTemplate(formTpl).on("render",function(){var self=this,$form=this.getElement(),$periodStart=$form.find("input[name=periodStart]"),$periodEnd=$form.find("input[name=periodEnd]"),$filterBtn=$form.find('[data-control="filter"]');$periodStart.datepicker({dateFormat:initConfig.dateFormat,autoSize:!0}).change(function(){periodStart=$periodStart.val(),$periodEnd.datepicker("option","minDate",periodStart),self.trigger("change","start",periodStart)}),$periodEnd.datepicker({dateFormat:initConfig.dateFormat,autoSize:!0}).change(function(){periodEnd=$periodEnd.val(),$periodStart.datepicker("option","maxDate",periodEnd),self.trigger("change","end",periodEnd)}),
$filterBtn.on("click",function(event){event.preventDefault(),periodStart=$periodStart.val(),periodEnd=$periodEnd.val(),self.trigger("submit")})}).init(initConfig)}}),define("taoProctoring/component/history/historyTable",["jquery","lodash","i18n","ui/component","ui/datatable"],function($,_,__,component){"use strict";var _defaults={sortBy:"timestamp",sortOrder:"desc"};function renderDetails(details){return _.isArray(details)&&(details=details.join("<br />")),details}return function(config,data){var initConfig=_.defaults(config||{},_defaults);return component({refresh:function(params){var $element;this.is("rendered")?($element=this.getElement(),
params&&$element.datatable("options",{params:params}),$element.datatable("refresh")):params&&(initConfig.params=_.merge(initConfig.params,params))}}).on("render",function(){var self=this,tools=[{id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){self.refresh()}}];this.getElement().on("query.datatable",function(){self.trigger("loading")}).on("load.datatable",function(){self.trigger("loaded")}).on("error.datatable",function(e,err){self.trigger("error",err)}).datatable({url:initConfig.service,params:initConfig.params,sortby:initConfig.sortBy,sortorder:initConfig.sortOrder,status:{empty:__("No history to display!"),
available:__("Available history"),loading:__("Loading")},selectable:!(!initConfig.tools||!_.find(initConfig.tools,{massAction:!0})),tools:tools.concat(initConfig.tools||[]),model:[{id:"date",label:__("Date"),sortable:!0},{id:"role",label:__("Role"),sortable:!0},{id:"actor",label:__("Actor"),sortable:!0},{id:"event",label:__("Event"),sortable:!0},{id:"details",label:__("Details"),transform:renderDetails},{id:"context",label:__("Context"),transform:renderDetails}]},data)}).init(initConfig)}}),define("tpl!taoProctoring/templates/reporting/index",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4
,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<div class="content">\r\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+="<h1>",stack1=(helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</h1>"},data),data:data}))||0===stack1)&&(buffer+=stack1),
buffer+='\r\n    <div class="panel"></div>\r\n    <div class="list clearfix"></div>\r\n</div>\r\n'})}),define("taoProctoring/controller/Reporting/history",["lodash","i18n","util/url","controller/app","layout/loading-bar","ui/container","ui/button","util/encode","taoProctoring/component/proxy","taoProctoring/component/dateRange","taoProctoring/component/history/historyTable","tpl!taoProctoring/templates/reporting/index","ui/datatable"],function(_,__,urlHelper,appController,loadingBar,containerFactory,buttonFactory,encode,proxyFactory,dateRangeFactory,historyTableFactory,indexTpl){"use strict";var serviceUrl=urlHelper.route("sessionHistory","Reporting",
"taoProctoring"),sessionsUrl=urlHelper.route("history","Reporting","taoProctoring");return loadingBar.start(),{start:function(){var container=containerFactory().changeScope(".session-history").write(indexTpl()),currentRoute=urlHelper.parse(window.location.href),context=currentRoute.query.context&&decodeURIComponent(currentRoute.query.context),deliveryId=currentRoute.query.delivery&&decodeURIComponent(currentRoute.query.delivery),sessions=decodeURIComponent(currentRoute.query.session).split(","),monitoringUrl=currentRoute.query.monitoring&&decodeURIComponent(currentRoute.query.monitoring);appController.on("set-referrer.history",function(route){
monitoringUrl=route}).on("change.history",function(){appController.off(".history"),container.destroy()}),proxyFactory("ajax").init({actions:{read:serviceUrl}}).then(function(proxyService){return proxyService.read({delivery:deliveryId,context:context,session:sessions}).then(function(data){var detailedHistory=data.detailedHistory,historyTable=historyTableFactory({tools:[{id:"show-detailed-report",icon:"insert-horizontal-line",title:__("Show detailed session history messages"),label:__("Show detailed report"),action:function(){var tool=_.find(historyTable.config.tools,{id:"show-detailed-report"})
;historyTable.config.params.detailed=detailedHistory=!detailedHistory,tool.label=__(detailedHistory?"Show brief report":"Show detailed report"),historyTable.refresh()}}],params:{detailed:detailedHistory,delivery:deliveryId,context:context,session:sessions},service:sessionsUrl,sortBy:data.sortBy,sortOrder:data.sortOrder},data.set).on("loading",function(){loadingBar.start()}).on("loaded",function(){loadingBar.stop()}).on("error",function(err){appController.onError(err)}).render(container.find(".list"));data.monitoringUrl&&(monitoringUrl=data.monitoringUrl),dateRangeFactory({start:data.periodStart,end:data.periodEnd,renderTo:container.find(".panel")}).on(
"change submit",function(){historyTable.refresh({periodStart:this.getStart(),periodEnd:this.getEnd()})}),buttonFactory({id:"back",type:"info",label:__("Back to sessions"),cls:"back-button",renderTo:container.find(".panel")}).on("click",function(){monitoringUrl?appController.getRouter().redirect(monitoringUrl):history.go(-1)})})}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/controller/routes",{Reporting:{actions:{index:"controller/Reporting/history"}},Irregularity:{actions:{index:"controller/Irregularity/index"}},DeliverySelection:{actions:{index:"controller/Delivery/index"}},Monitor:{actions:{
index:"controller/Delivery/monitoring"}},Tools:{css:"tools",actions:{assessmentActivity:"controller/Tools/assessmentActivity"}}}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="col-',buffer+=escapeExpression((helper=helpers.size)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.size)?helper.call(depth0,{hash:{},
data:data}):helper)+' dashboard-block">\r\n        <span class="dashboard-block-number ',buffer+=escapeExpression((helper=helpers.container)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.container)?helper.call(depth0,{hash:{},data:data}):helper)+'">\r\n            ',buffer+=escapeExpression((helper=helpers.value)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.value)?helper.call(depth0,{hash:{},data:data}):helper)+'\r\n        </span>\r\n    <h3>\r\n        <span class="icon icon-test-',buffer+=escapeExpression((helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(
helper=depth0&&depth0.icon)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\r\n        ',buffer+=escapeExpression((helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,{hash:{},data:data}):helper)+"\r\n    </h3>\r\n</div>"})}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivity",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),data=data||{};var stack1,buffer="",
self=this;return buffer+="<div>\r\n    ",((stack1=helpers.each.call(depth0,depth0,{hash:{},inverse:self.noop,fn:self.program(1,function(depth0,data){var stack1,buffer="";return buffer+="\r\n    ",((stack1=self.invokePartial(partials["ui-activity-widget-group"],"ui-activity-widget-group",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+="\r\n    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n</div>"})}),define("taoProctoring/component/activityMonitoring/userActivity/userActivity",["jquery","lodash","i18n","ui/component","handlebars","tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock",
"tpl!taoProctoring/component/activityMonitoring/userActivity/userActivity"],function($,_,__,component,Handlebars,groupTpl,componentTpl){"use strict";var _defaults={activeProctors:{container:"active-proctors",label:__("Active proctors"),size:4,icon:"taker",value:0},activeTestTakers:{container:"active-test-takers",label:__("Active test-takers"),size:4,icon:"takers",value:0}};return Handlebars.registerPartial("ui-activity-widget-group",groupTpl),function(config){return config=config||{},component({update:function(data){var metricsWidget;for(metricsWidget in _.merge(this.config,data),this.config)this.config.hasOwnProperty(metricsWidget)&&$(
"."+this.config[metricsWidget].container,this.getElement()).text(this.config[metricsWidget].value)}},_defaults).setTemplate(componentTpl).init(config)}}),define("tpl!taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",escapeExpression=this.escapeExpression
;return buffer+='<div>\r\n    <div class="col-4 dashboard-block">\r\n        <h4>\r\n            <span class="icon icon-play"></span>\r\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\r\n        </h4>\r\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\r\n            '+escapeExpression(
"function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\r\n        </span>\r\n    </div>\r\n\r\n    <div class="col-2 dashboard-block">\r\n        <h4>\r\n            <span class="icon icon-play"></span>\r\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\r\n        </h4>\r\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(
stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\r\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\r\n        </span>\r\n    </div>\r\n\r\n    <div class="col-2 dashboard-block">\r\n        <h4>\r\n            <span class="icon icon-time"></span>\r\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments
)||!1===stack1?stack1:stack1.awaiting)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\r\n        </h4>\r\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.awaiting)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\r\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.awaiting)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1
...
)+'\r\n        </h4>\r\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.paused)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\r\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.paused)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+"\r\n        </span>\r\n    </div>\r\n</div>"})}),define("taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity",["jquery","lodash",
"i18n","ui/component","tpl!taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity"],function($,_,__,component,tpl){"use strict";var _defaults={assessments:{awaiting:{container:"awaiting-assessments",label:__("Awaiting"),value:0},authorized:{container:"authorized-but-not-started-assessments",label:__("Authorized"),value:0},current:{container:"current-assessments",label:__("Total Current Assessments"),value:0},inProgress:{container:"in-progress-assessments",label:__("In Progress"),value:0},paused:{container:"paused-assessments",label:__("Paused"),value:0}}};return function(config){return config=config||{},component({
update:function(data){_.merge(this.config.assessments,data),_.each(this.config.assessments,function(val){$("."+val.container,this.getElement()).text(val.value)},this)}},_defaults).setTemplate(tpl).init(config)}}),define("tpl!taoProctoring/component/activityMonitoring/progressbar",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{},'<div class="js-completed-assessments-refresh-bar refresh-bar">\r\n    <div class="js-refresh-bar-progress refresh-bar-progress"></div>\r\n</div>'})}),define(
"taoProctoring/component/activityMonitoring/activityGraph",["jquery","lodash","i18n","ui/component","util/url","c3","tpl!taoProctoring/component/activityMonitoring/progressbar","core/polling"],function($,_,__,component,url,c3,progressbarTpl,pollingFactory){"use strict";var _defaults={autoRefresh:0,autoRefreshBar:!1,transition:{duration:3e3},graphConfig:{padding:{bottom:0,left:35},data:{x:"time",xFormat:"%Y-%m-%d %H:%M:%S",mimeType:"json",type:"bar"},axis:{x:{type:"timeseries",tick:{format:"%H:%M"},label:{position:"bottom center"}},y:{label:{position:"top"}}}}};function runRefreshProgressBar($refreshProgress,duration){duration/=1e3,$refreshProgress.css({
"-webkit-transition":"width 0s","-moz-transition":"width 0s","-o-transition":"width 0s",transition:"width 0s",width:"0%"}),$refreshProgress.hide().show(),$refreshProgress.css({"-webkit-transition":"width "+duration+"s linear","-moz-transition":"width "+duration+"s linear","-o-transition":"width "+duration+"s linear",transition:"width "+duration+"s linear",width:"100%"})}return function(config){var chart,$refreshProgress,$progressbar,polling,initConfig=_.merge({},_defaults,config);return component({refresh:function(newConfig){chart&&(initConfig=_.merge({},initConfig,newConfig),chart.internal.config.axis_x_tick_format=initConfig.graphConfig.axis.x.tick.format,
chart.axis.labels({x:initConfig.graphConfig.axis.x.label.text}),chart.load(initConfig.graphConfig.data))}}).on("render",function(){chart=c3.generate(initConfig.graphConfig),initConfig.autoRefresh&&($progressbar=$(progressbarTpl()),$(initConfig.graphConfig.bindto).after($progressbar),$refreshProgress=$progressbar.find(".js-refresh-bar-progress"),initConfig.autoRefreshBar&&runRefreshProgressBar($refreshProgress,initConfig.autoRefresh),polling=pollingFactory({action:function(){chart.load(initConfig.graphConfig.data),initConfig.autoRefreshBar&&runRefreshProgressBar($refreshProgress,initConfig.autoRefresh)},interval:initConfig.autoRefresh,autoStart:!0}))}).on(
"destroy",function(){polling&&polling.stop()}).init(initConfig)}}),define("taoProctoring/component/activityMonitoring/deliveriesList/deliveriesList",["jquery","i18n","util/url","ui/component","util/locale","ui/datatable"],function($,__,url,component,locale){"use strict";var _defaults={model:[{id:"label",label:__("Delivery"),sortable:!0},{id:__("Awaiting"),label:__("Awaiting"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Authorized"),label:__("Authorized"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Paused"),label:__("Paused"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Active"
),label:__("Active"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Terminated"),label:__("Terminated"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Canceled"),label:__("Canceled"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Finished"),label:__("Finished"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Last launch"),label:__("Last launch"),sortable:!0,transform:function(value){return locale.formatDateTime(value)}}]};return function(config){return config=config||{},component({update:function(){this.$datatable.datatable("refresh")}},_defaults).on("render",
function(){this.$datatable=this.getElement().datatable({url:url.route("deliveriesActivityData","Tools","taoProctoring"),filter:!1,model:this.config.model,paginationStrategyTop:"none",paginationStrategyBottom:"simple",rows:10,selectable:!0,sortorder:"asc",sortby:"label"},this.config.model)}).init(config)}}),define("taoProctoring/controller/Tools/assessmentActivity",["jquery","d3","lodash","i18n","helpers","util/url","core/dataProvider/request","core/polling","ui/feedback","ui/cascadingComboBox","ui/bulkActionPopup","taoProctoring/component/activityMonitoring/userActivity/userActivity",
"taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity","taoProctoring/component/activityMonitoring/activityGraph","taoProctoring/component/activityMonitoring/deliveriesList/deliveriesList"],function($,d3,_,__,helpers,url,request,polling,feedback,cascadingComboBox,bulkActionPopup,userActivityFactory,currentAssessmentActivityFactory,activityGraphFactory,deliveriesListFactory){"use strict";var pauseMsg=__("Warning, you are about to pause all in progress tests. All test takers will be paused on or before the next heartbeat. Please provide a reason for this action.");return{start:function(){var activityGraph,
assessmentActivityAutoRefreshInterval,completedAssessmentsAutoRefreshInterval,config,currentAssessmentActivity,deliveriesList,pauseReasonCategories,poll,userActivity,$container=$(".activity-dashboard");config=$container.data("config"),assessmentActivityAutoRefreshInterval=1e3*parseInt(config.assessment_activity_auto_refresh),completedAssessmentsAutoRefreshInterval=1e3*parseInt(config.completed_assessments_auto_refresh),userActivity=userActivityFactory(config.userActivityWidgets).render($(".user-activity",$container)),currentAssessmentActivity=currentAssessmentActivityFactory().render($(".assessment-activity",$container)),activityGraph=activityGraphFactory({
autoRefresh:Math.max(completedAssessmentsAutoRefreshInterval,assessmentActivityAutoRefreshInterval),autoRefreshBar:!0,graphConfig:{bindto:$(".js-completed-assessments",$container).selector,data:{url:url.route("completedAssessmentsData","Tools","taoProctoring")},axis:{x:{label:{text:__("Hours")}},y:{label:{text:__("Completed tests")},tick:{format:d3.format("d")}}},tooltip:{format:{name:function(){return __("Completed")}}},legend:{show:!1}}}).render(),$(".js-activity-chart-interval",$container).on("change",function(){var interval=$(this).val();activityGraph.refresh({graphConfig:{data:{url:url.route("completedAssessmentsData","Tools","taoProctoring",{
interval:interval})},axis:{x:{tick:{format:"day"===interval?"%H:%M":"%m-%d"},label:{text:__("day"===interval?"Hours":"Days")}}}}})}),deliveriesList=deliveriesListFactory().render($(".js-delivery-list")),poll=polling({action:function(){request(url.route("assessmentActivityData","Tools","taoProctoring")).then(function(data){var uaData={};data&&data.group_user_activity&&_.forEach(data.group_user_activity,function(v,k){uaData[$.camelCase(k.replace(/_/g,"-"))]={value:v}}),userActivity.update(uaData),currentAssessmentActivity.update({awaiting:{value:data&&data.awaiting_assessments},authorized:{value:data&&data.authorized_but_not_started_assessments},current:{
...
categoriesSelector:cascadingComboBox(pauseReasonCategories.pause)}).on("ok",function(reason){!function(reason){request(url.route("pauseActiveExecutions","Tools","taoProctoring"),{reason:reason},"POST").then(function(data){helpers.loaded(),feedback().success(data.message)}).catch(function(err){helpers.loaded(),feedback().error(err.message)})}(reason)})})}}}),define("taoProctoring/helper/textConverter",["jquery","lodash","core/format","core/promise","util/url"],function($,_,format,Promise,url){"use strict";var pendingPromise,labels=null,proctoringLabels={get:function(message){null==labels[message]&&console.log(message)
;var localized=labels[message]?labels[message]:message;return 1<arguments.length&&(message=localized,localized=format.apply(null,arguments)),localized}};return function(){return pendingPromise||(pendingPromise=new Promise(function(resolve,reject){$.ajax({url:url.route("getAll","TextConverter","taoProctoring"),type:"POST",dataType:"json"}).done(function(data){labels=data.translations,resolve(proctoringLabels)}).fail(reject)})),pendingPromise}}),define("taoProctoringloader\taoProctoring.bundle",function(){}),window.bundles=(window.bundles||[]).concat(["taoQtiItem/loader/taoQtiItem.min","taoItems/loader/taoItems.min","taoQtiTest/loader/taoQtiTest.min"]);
