...
_paused="http://www.tao.lu/Ontologies/TAODelivery.rdf#DeliveryExecutionStatusPaused",_completed="http://www.tao.lu/Ontologies/TAODelivery.rdf#DeliveryExecutionStatusFinished",_terminated="http://www.tao.lu/Ontologies/TAODelivery.rdf#DeliveryExecutionStatusTerminated",_status={inprogress:{code:_inprogress,label:__("In Progress"),can:{authorize:__("already authorized"),pause:!0,terminate:!0,report:!0,print:__("not finished"),reactivate:__("not terminated"),time:!0},warning:{authorize:function(username,testId){return testId?__("Test %s had already been authorized.",testId):username?__("%s's test had already been authorized.",username):__(
"Test had already been authorized.")},print:function(username,testId){return testId?__("Test %s had not been finished.",testId):username?__("%s's test had not been finished.",username):__("Test had not been finished.")},reactivate:function(username,testId){return testId?__("Test %s must be terminated.",testId):username?__("%s's test must be terminated.",username):__("Test  must be terminated.")}}},authorized:{code:_authorized,label:__("Authorized but not started"),can:{authorize:__("already authorized"),terminate:!0,report:!0,pause:__("not started"),print:__("not finished"),reactivate:__("not terminated"),time:!0},warning:{authorize:function(username,testId
){return testId?__("Test %s had already been authorized.",testId):username?__("%s's test had already been authorized.",username):__("Test had already been authorized.")},pause:function(username,testId){return testId?__("Test %s had not been started.",testId):username?__("%s's test had not been started.",username):__("Test had not been started.")},print:function(username,testId){return testId?__("Test %s had not been finished.",testId):username?__("%s's test had not been finished.",username):__("Test had not been finished.")},reactivate:function(username,testId){return testId?__("Test %s must be terminated.",testId):username?__("%s's test must be terminated."
,username):__("Test  must be terminated.")}}},awaiting:{code:"http://www.tao.lu/Ontologies/TAODelivery.rdf#DeliveryExecutionStatusAwaiting",label:__("Awaiting"),can:{authorize:!0,pause:__("not in progress"),terminate:!0,reactivate:__("not terminated"),report:!0,print:__("not finished"),time:!0},warning:{pause:function(username,testId){return testId?__("Test %s had not been in progress.",testId):username?__("%s's test had not been in progress.",username):__("Test had not been in progress.")},print:function(username,testId){return testId?__("Test %s had not been finished.",testId):username?__("%s's test had not been finished.",username):__(
"Test had not been finished.")},reactivate:function(username,testId){return testId?__("Test %s must be terminated.",testId):username?__("%s's test must be terminated.",username):__("Test  must be terminated.")}}},canceled:{code:"http://www.tao.lu/Ontologies/TAODelivery.rdf#DeliveryExecutionStatusCanceled",label:__("Canceled"),can:{authorize:__("canceled"),pause:__("canceled"),terminate:__("canceled"),reactivate:__("not terminated"),report:!0,print:__("canceled"),time:!0},warning:{authorize:function(username,testId){return testId?__("Test %s had been canceled.",testId):username?__("%s's test had been canceled.",username):__("Test had been canceled.")},
pause:function(username,testId){return testId?__("Test %s had been canceled.",testId):username?__("%s's test had been canceled.",username):__("Test had been canceled.")},terminate:function(username,testId){return testId?__("Test %s had been canceled.",testId):username?__("%s's test had been canceled.",username):__("Test had been canceled.")},reactivate:function(username,testId){return testId?__("Test %s had been canceled.",testId):username?__("%s's test had been canceled.",username):__("Test had been canceled.")},print:function(username,testId){return testId?__("Test %s had been canceled.",testId):username?__("%s's test had been canceled.",username):__(
"Test had been canceled.")}}},completed:{code:_completed,label:__("Completed"),can:{authorize:__("completed"),pause:__("completed"),terminate:__("completed"),reactivate:__("not terminated"),report:!0,print:!0,time:!0},warning:{authorize:function(username,testId){return testId?__("Test %s had been completed.",testId):username?__("%s's test had been completed.",username):__("Test had been completed.")},pause:function(username,testId){return testId?__("Test %s had been completed.",testId):username?__("%s's test had been completed.",username):__("Test had been completed.")},terminate:function(username,testId){return testId?__("Test %s had been completed.",testId
...
report:!0,reactivate:!0,print:!0,time:!0},warning:{authorize:function(username,testId){return testId?__("Test %s had been terminated.",testId):username?__("%s's test had been terminated.",username):__("Test had been terminated.")},pause:function(username,testId){return testId?__("Test %s had been terminated.",testId):username?__("%s's test had been terminated.",username):__("Test had been terminated.")},terminate:function(username,testId){return testId?__("Test %s had already been terminated.",testId):username?__("%s's test had already been terminated.",username):__("Test had alredy been terminated.")}}}};return{buildWarningMessage:function(action,selection,
deniedResources){var warningAction,warningReason,isPlural=1<selection.length,warningOmission=__("...");switch(deniedResources=deniedResources||[{}],action){case"authorize":warningAction=__(isPlural?"Cannot authorize test sessions.":"Cannot authorize test session.");break;case"pause":warningAction=__(isPlural?"Cannot pause test sessions.":"Cannot pause test session.");break;case"terminate":warningAction=__(isPlural?"Cannot terminate test sessions.":"Cannot terminate test session.");break;case"reactivate":warningAction=__(isPlural?"Cannot reactivate test sessions.":"Cannot reactivate test session.");break;case"report":warningAction=__(
isPlural?"Cannot report test sessions.":"Cannot report test session.");break;case"print":warningAction=__(isPlural?"Cannot print test sessions.":"Cannot print test session.");break;case"time":warningAction=__(isPlural?"Cannot extend test sessions.":"Cannot extend test session.");break;default:warningAction=__("Cannot execute action.")}return warningReason=_(deniedResources).slice(0,2).map(function(deniedResource){return deniedResource.warning}).join(" "),2<deniedResources.length&&(warningReason+=warningOmission),warningAction+" "+warningReason},getStatuses:function(){return _.map(_status,function(el){return{code:el.code,label:el.label}})},getStatus:function(
statusName){return _status[statusName]},getStatusByCode:function(statusCode){return _.find(_status,{code:statusCode})},verifyTestTaker:function(testTakerData,actionName){var formatted={id:testTakerData.id,label:testTakerData.firstname+" "+testTakerData.lastname},status=_status.getStatusByCode(testTakerData.state.status);return status&&(formatted.allowed=!0===status.can[actionName],formatted.allowed||(formatted.reason=status.can[actionName])),formatted},STATUS_AUTHORIZED:_authorized,STATUS_INPROGRESS:_inprogress,STATUS_PAUSED:_paused,STATUS_COMPLETED:_completed,STATUS_TERMINATED:_terminated}}),define("taoProctoring/component/proxy",["core/dataProvider/proxy",
"core/dataProvider/proxy/ajax"],function(proxyFactory,ajaxProxy){"use strict";return proxyFactory.registerProvider("ajax",ajaxProxy)}),define("tpl!taoProctoring/templates/delivery/index",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<div class="content">\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer=""
;return buffer+="<h1>",stack1=(helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</h1>"},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n    <div class="panel"></div>\n    <div class="list clearfix"></div>\n</div>\n'})}),define("tpl!taoProctoring/templates/delivery/listBoxActions",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,options,buffer="",
escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<span class="listbox-actions">\n    <span class="action pause" data-delivery="',buffer+=escapeExpression((helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.id)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n        <span class="icon-pause"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Pause",options):helperMissing.call(depth0,"__","Pause",options))
)+'\n    </span>\n    <span class="action play">\n        <span class="icon-play"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Monitor",options):helperMissing.call(depth0,"__","Monitor",options)))+"\n    </span>\n</span>"})}),define("tpl!taoProctoring/templates/delivery/listBoxStats",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression,functionType="function"
;return((stack1=helpers.if.call(depth0,depth0&&depth0.showProperties,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,options,buffer="";return buffer+='\n<ul class="plain listbox-properties">\n    <li>\n        <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Start",options):helperMissing.call(depth0,"__","Start",options)))+"</label>: ",stack1=(helper=helpers.periodStart)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.periodStart)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+"\n    </li>\n    <li>\n        <label>"+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"End",options):helperMissing.call(depth0,"__","End",options)))+"</label>: ",stack1=(helper=helpers.periodEnd)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.periodEnd)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"\n    </li>\n</ul>\n"},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n<p class="listbox-stats">\n    <span class="icon-lock"></span><span class="number">',stack1=(helper=helpers.locked)?helper.call(depth0,{hash:{},
data:data}):typeof(helper=depth0&&depth0.locked)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</span>\n    <span class="icon-play"></span><span class="number">',stack1=(helper=helpers.inProgress)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.inProgress)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</span>\n    <span class="icon-pause"></span><span class="number">',stack1=(helper=helpers.paused)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.paused)===functionType?helper.call(depth0,{hash:{},data:data}):helper,
buffer+=escapeExpression(stack1)+"</span>\n</p>"})}),define("taoProctoring/controller/Delivery/index",["jquery","lodash","i18n","module","core/promise","controller/app","util/url","layout/loading-bar","ui/listbox","util/encode","ui/feedback","ui/bulkActionPopup","ui/cascadingComboBox","ui/container","taoProctoring/helper/status","taoProctoring/component/proxy","tpl!taoProctoring/templates/delivery/index","tpl!taoProctoring/templates/delivery/listBoxActions","tpl!taoProctoring/templates/delivery/listBoxStats","util/locale"],function($,_,__,module,Promise,appController,urlHelper,loadingBar,listBoxFactory,encode,feedback,bulkActionPopup,cascadingComboBox,
containerFactory,_status,proxyFactory,indexTpl,actionsTpl,statsTpl,locale){"use strict";var serviceUrl=urlHelper.route("deliveries","DeliverySelection","taoProctoring"),pauseUrl=urlHelper.route("pauseExecutions","Monitor","taoProctoring"),sessionsUrl=urlHelper.route("deliveryExecutions","Monitor","taoProctoring");function validateParams(params){return _.isPlainObject(params)&&(_.isUndefined(params.delivery)||!_.isEmpty(params.delivery))&&(_.isUndefined(params.execution)||!_.isEmpty(params.execution))&&(_.isUndefined(params.reason)||!_.isEmpty(params.reason))}return loadingBar.start(),{start:function(){var deliveries,categories,proxyDeliveries,proxySessions,
title=__("Sessions"),context=module.config().context,container=containerFactory(".container").changeScope(".delivery-index").write(indexTpl({title:title})),listBox=listBoxFactory({title:title,textEmpty:__("No sessions available"),textNumber:__("Available"),textLoading:__("Loading"),renderTo:container.find(".content"),replace:!0,list:[],width:12,countRenderer:function(count){return count-1}});appController.on("change.deliveryIndex",function(){appController.off(".deliveryIndex"),listBox.destroy(),container.destroy()}),Promise.all([proxyFactory("ajax").init({actions:{read:serviceUrl}}).then(function(proxy){proxyDeliveries=proxy}),proxyFactory("ajax").init({
actions:{read:{url:sessionsUrl,validate:validateParams},pause:{url:pauseUrl,validate:validateParams}}}).then(function(proxy){proxySessions=proxy})]).then(function(){function getDeliveryLabel(id){return deliveries[id]&&deliveries[id].label}function refresh(){return loadingBar.start(),listBox.setLoading(!0),proxyDeliveries.read({context:context}).then(function(data){categories=data.categories,deliveries=_.transform(data.list,function(result,delivery){var props=delivery.properties,tplData={locked:delivery.stats.awaitingApproval,inProgress:delivery.stats.inProgress,paused:delivery.stats.paused};props&&props.periodStart&&props.periodEnd&&(
tplData.showProperties=!0,tplData.periodStart=props.periodStart,tplData.periodEnd=props.periodEnd,delivery.cls="has-properties-displayed"),delivery.html=actionsTpl({id:delivery.id}),delivery.content=statsTpl(tplData),delivery.cls=((delivery.cls||"")+" router").trim(),result[delivery.id]=delivery},{}),listBox.update(data.list),loadingBar.stop()}).catch(function(err){appController.onError(err)})}function pause(deliveryId,selection,deliveryExecutions){return new Promise(function(resolve,reject){var sessions;bulkActionPopup({renderTo:container.getElement(),actionName:__("Pause Session"),reason:!0,resourceType:"session",categoriesSelector:cascadingComboBox({
categoriesDefinitions:categories.pause.categoriesDefinitions,categories:categories.pause.categories}),allowedResources:(sessions=selection,_.map(sessions,function(session){return{id:session.id,label:session.delivery.label+" ["+locale.formatDateTime(session.start_time)+"]"}}))}).on("cancel",resolve).on("ok",function(reason){proxySessions.action("pause",{delivery:deliveryId,execution:_.pluck(selection,"id"),reason:reason}).then(function(){feedback().success("Selected deliveries successfully paused"),refresh().then(resolve).catch(reject)}).catch(function(err){err.response?(feedback().warning(__("Something went wrong ...")+"<br>"+function(response,
...
messageContext+="<br>"+encode.html(response.error))),messageContext}(err.response,deliveryExecutions),{encodeHtml:!1}),resolve()):reject(err)})})})}listBox.getElement().on("click",".pause",function(e){var deliveryId=$(this).data("delivery");loadingBar.start(),e.stopPropagation(),e.preventDefault(),proxySessions.read({delivery:deliveryId,context:context}).then(function(sessions){var inProgressExecs,deliveryExecutions={};if((inProgressExecs=_.filter(sessions,function(session){return(deliveryExecutions[session.id]=session).state&&session.state.status===_status.getStatus("inprogress").code})).length)return pause(deliveryId,inProgressExecs,deliveryExecutions)
;feedback().info(__("There is no delivery in progress"))}).catch(function(err){appController.onError(err)}).then(function(){loadingBar.stop()})}),refresh()}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/component/breadcrumbs",["ui/breadcrumbs"],function(breadcrumbs){"use strict";return function($container,crumbs){return breadcrumbs({breadcrumbs:crumbs,renderTo:$container.find(".header"),replace:!0,cls:"action-bar horizontal-action-bar"})}}),define("taoProctoring/controller/Delivery/manage",["jquery","i18n","helpers","layout/loading-bar","util/encode","ui/feedback","ui/dialog",
"taoProctoring/component/breadcrumbs","ui/datatable"],function($,__,helpers,loadingBar,encode,feedback,dialog,breadcrumbsFactory){"use strict";return loadingBar.start(),{start:function(){var $container=$(".delivery-manager"),$list=$container.find(".list"),crumbs=$container.data("breadcrumbs"),dataset=$container.data("set"),deliveryId=$container.data("delivery"),testCenterId=$container.data("testcenter"),assignUrl=helpers._url("testTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),removeUrl=helpers._url("removeTestTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),serviceUrl=helpers._url(
"deliveryTestTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),monitoringUrl=helpers._url("monitoring","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),remove=(breadcrumbsFactory($container,crumbs),function(selection){!function(url,selection,message){selection&&selection.length&&(loadingBar.start(),$.ajax({url:url,data:{testtaker:selection},dataType:"json",type:"POST",error:function(){loadingBar.stop()}}).done(function(response){loadingBar.stop(),response&&response.success?(message&&feedback().success(message),$list.datatable("refresh")):feedback().error(__("Something went wrong ..."
)+"<br>"+encode.html(response.error),{encodeHtml:!1})}))}(removeUrl,selection,__("Test takers have been removed"))});$list.on("query.datatable",function(){loadingBar.start()}).on("load.datatable",function(){loadingBar.stop()}).datatable({url:serviceUrl,status:{empty:__("No assigned test takers"),available:__("Assigned test takers"),loading:__("Loading")},tools:[{id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){$list.datatable("refresh")}},{id:"back",icon:"preview",title:__("Return to the session monitoring"),label:__("Monitoring"),action:function(){window.location.href=monitoringUrl}},{id:"assign",icon:"add",
title:__("Assign more test takers to this session"),label:__("Add test takers"),action:function(){window.location.href=assignUrl}},{id:"remove",icon:"remove",title:__("Remove the selected test takers from the session"),label:__("Remove"),massAction:!0,action:function(selection){dialog({message:__("The test takers will be removed from this session. Continue ?"),autoRender:!0,autoDestroy:!0,onOkBtn:function(){remove(selection)}})}}],actions:[{id:"remove",icon:"remove",title:__("Remove the test taker from the session"),action:function(id){dialog({autoRender:!0,autoDestroy:!0,message:__("The test taker will be removed from this session. Continue ?"),
onOkBtn:function(){remove([id])}})}}],selectable:!0,model:[{id:"firstname",label:__("First name")},{id:"lastname",label:__("Last name")},{id:"identifier",label:__("Identifier")},{id:"status",label:__("Status")}]},dataset)}}}),define("taoProctoring/component/extraTime/encoder",["core/format","core/encoder/time"],function(format,timeEncoder){"use strict";return function(extraTime,consumedTime,pattern,unit){var encoded="";return pattern=pattern||"%s",unit=unit||1,extraTime&&(encoded=" +"+(encoded=consumedTime?timeEncoder.encode(Math.min(consumedTime,extraTime))+"/"+timeEncoder.encode(extraTime):"HH:mm:ss"===pattern?timeEncoder.encode(extraTime):format(pattern,
extraTime/unit))),encoded}}),define("tpl!taoProctoring/component/extraTime/extraTime",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,self=this,helperMissing=helpers.helperMissing;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='\n            <li data-resource="',stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,
...
".tool-tag").hide():$list.find(".action-bar").children(".tool-notag").hide())}function statusFilterHandler($el){$el.select2({dropdownAutoWidth:!0,placeholder:__("Filter"),minimumResultsForSearch:1/0,allowClear:!0})}return deliveryId&&(serviceParams.delivery=deliveryId),context&&(serviceParams.context=context),proxyExecutions.read(serviceParams).then(function(data){var now,nowStr;dataset=data.set,extraFields=data.extrafields,categories=data.categories,deliveryId=data.delivery||deliveryId,context=data.context||context,timeHandlingButton=data.timeHandling,allowedConnectivity=data.onlineStatus||!1,printReportButton=data.printReportButton,
printReportUrl=data.printReportUrl,hasAccessToReactivate=data.hasAccessToReactivate,sessionsHistoryUrl=data.historyUrl||historyUrl,deliveryId&&(serviceParams.delivery=deliveryId),context&&(serviceParams.context=context),data.refreshBtn&&tools.push({id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){$list.datatable("refresh")}}),data.autoRefresh&&setInterval(function(){$list.datatable("refresh")},data.autoRefresh),defaultTag&&(tools.push({id:"notag",icon:"filter",css:"btn-warning",label:__("Remove default tag filtering"),title:__("Remove default tag filtering"),action:function(){setTagUsage(!1),$list.datatable(
...
filterTransform:function(value){var values=value.split(" - "),result="",dateFormat=locale.getDateTimeFormat();return values[0]&&(result=moment(values[0],dateFormat).format("X")),values[1]&&(values[1]=moment(values[1],dateFormat).add(1,"d").format("X"),""!==result&&(result+=" - "),result+=values[1]),result},customFilter:{template:'<input type="text" id="start_time_filter" name="filter[start_time]"/><button class="icon-find js-start_time_filter_button" type="button"></button>',callback:function($el){var dateFormatStr=locale.getDateTimeFormat().split(" ")[0];dateFormatStr=(dateFormatStr=(dateFormatStr=dateFormatStr.replace("YYYY","yy")).replace("MM","mm")
).replace("DD","dd"),$el.datepicker({dateFormat:dateFormatStr,onSelect:function(selectedDate){var datePickerData=$(this).data().datepicker;datePickerData.first?(moment(datePickerData.first,"MM/DD/YYYY").format("X")<moment(selectedDate,"MM/DD/YYYY").format("X")?$(this).val(datePickerData.first+" - "+selectedDate):$(this).val(selectedDate+" - "+datePickerData.first),datePickerData.inline=!1,$(".js-start_time_filter_button").trigger("click")):(datePickerData.inline=!0,datePickerData.first=selectedDate)},onClose:function(event){event.which===$.ui.keyCode.ENTER&&(event.preventDefault(),$el.datepicker("hide"))}})}}}),model.push({id:"status",label:__("Status"),
sortable:!0,filterable:!0,customFilter:{template:statusFilterTpl({statuses:_status.getStatuses()}),callback:statusFilterHandler},transform:function(value,row){var status,result="";return row&&row.state&&row.state.status&&(status=_status.getStatusByCode(row.state.status))&&(result=status.label,"INPROGRESS"===row.state.status&&(result=status.label),"Awaiting"===result&&highlightRows.push(row.id)),result}}),model.push({id:"authorizeCl",label:__("Authorize"),type:"actions",actions:[{id:"authorize",icon:"play",title:__("Authorize session"),disabled:function(){return!canDo("authorize",this.state)},action:authorize}]}),(null===data.canPause||data.canPause
)&&model.push({id:"pauseCl",label:__("Pause"),type:"actions",actions:[{id:"pause",icon:"pause",title:__("Pause session"),disabled:function(){return!canDo("pause",this.state)},action:pause}]}),model.push({id:"remaining_time",sortable:!0,sorttype:"numeric",label:__("Remaining"),transform:function(value,row){var rowTimer=_.isObject(row.timer)?row.timer:{},refinedValue=rowTimer.approximatedRemaining?rowTimer.approximatedRemaining:rowTimer.remaining_time,remaining=parseInt(refinedValue,10);return(remaining||_.isFinite(remaining))&&(remaining<0&&(rowTimer.extraTime&&rowTimer.consumedExtraTime&&(rowTimer.consumedExtraTime+=-remaining),remaining=0),
refinedValue=remaining?(rowTimer.extraTime&&rowTimer.consumedExtraTime&&(remaining-=rowTimer.consumedExtraTime),timeEncoder.encode(remaining)):"",refinedValue=approximatedTimerTpl({timer:refinedValue,remaining:remaining,countDown:rowTimer.countDown})),refinedValue}}),timeHandlingButton&&model.push({id:"extraTime",label:__("Extra Time"),type:"actions",actions:[{id:"timeHandling",title:__("Session time handling"),icon:"time",action:timeHandling,hidden:function(){var allowExtraTime=_.isNull(this.allowExtraTime)||this.allowExtraTime;return!canDo("time",this.state)||!allowExtraTime}}]}),model.push({id:"extendedTime",label:__("Extended Time"),transform:function(
value,row){var extendedTimer=_.isObject(row.timer)?row.timer:{};return(extendedTimer.extendedTime?"x":"")+extendedTimer.extendedTime}}),allowedConnectivity&&model.push({id:"last_connect",sortable:!0,label:__("Connectivity"),transform:function(value,row){return row.state.status===_status.STATUS_INPROGRESS?row.online?__("online"):__("offline"):""}}),model.push({id:"progress",label:__("Progress"),transform:function(value,row){return row&&row.state&&row.state.progress||""}}),label="Terminate and irregularity",hasAccessToReactivate&&(label="Terminate/Reactivate and irregularity"),actionList=[{id:"terminateOrReactivateAndIrregularity",icon:"delivery-small",
...
".tool-pause"),terminate:$list.find(".action-bar").children(".tool-terminate"),report:$list.find(".action-bar").children(".tool-irregularity")}),defaultTag&&(applyTags=$list.data("applytags"),setTagUsage(applyTags=!!_.isUndefined(applyTags)||applyTags)),highlightRows.length&&_.forEach(highlightRows,function(v){$list.datatable("highlightRow",v)}),loadingBar.stop(),appController.off("change.polling").on("change.polling",function(){polling.stop()}),polling.start(),timer.resume()}).on("select.datatable",function(){actionButtons.each(function($btn){$btn.hide()}),_($list.datatable("selection")).map(function(uri){return getExecutionData(uri).state.status}).uniq(
).each(function(statusCode){var status=_status.getStatusByCode(statusCode);actionButtons.forIn(function($btn,action){status&&!0===status.can[action]&&$btn.show()})})}).on("error.datatable",function(e,err){appController.onError(err)}).datatable({url:urlHelper.build(executionsUrl,serviceParams),status:{empty:__("No sessions"),available:function(){return $list.data("applytags")?__("Groups: %s. %s",defaultTag.split(",").join(", "),defaultAvailableLabel):defaultAvailableLabel},loading:__("Loading")},filterStrategy:"multiple",filterSelector:"select, input:not(.select2-input, .select2-focusser)",filter:!0,tools:tools,model:model,selectable:!0,sortorder:"desc",
sortby:"start_time"},dataset),now=new Date,nowStr=(nowStr=(nowStr=(nowStr=locale.getDateTimeFormat().split(" ")[0]).replace("YYYY",now.getFullYear())).replace("MM",("0"+(now.getMonth()+1)).slice(-2))).replace("DD",("0"+now.getDate()).slice(-2)),$("#start_time_filter").val(nowStr+" - "+nowStr),defaultTag&&setTagUsage(!0),$list.datatable("filter")})}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/controller/Delivery/testTakers",["jquery","i18n","helpers","layout/loading-bar","util/encode","ui/feedback","taoProctoring/component/breadcrumbs","ui/datatable"],function($,__,helpers,loadingBar,encode,feedback,
breadcrumbsFactory){"use strict";return loadingBar.start(),{start:function(){var $container=$(".delivery-testtakers"),$list=$container.find(".list"),crumbs=$container.data("breadcrumbs"),dataset=$container.data("set"),deliveryId=$container.data("delivery"),testCenterId=$container.data("testcenter"),serviceUrl=helpers._url("availableTestTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),assignUrl=helpers._url("assignTestTakers","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),managerUrl=helpers._url("manage","Delivery","taoProctoring",{delivery:deliveryId,testCenter:testCenterId}),assign=(
breadcrumbsFactory($container,crumbs),function(selection){selection&&selection.length&&(loadingBar.start(),$.ajax({url:assignUrl,data:{testtaker:selection},dataType:"json",type:"POST",error:function(){loadingBar.stop()}}).done(function(response){loadingBar.stop(),response&&response.success?(feedback().success(__("Test takers have been added")),window.location.href=managerUrl):feedback().error(__("Something went wrong ...")+"<br>"+encode.html(response.error),{encodeHtml:!1})}))});$list.on("query.datatable",function(){loadingBar.start()}).on("load.datatable",function(event,response){loadingBar.stop()}).datatable({url:serviceUrl,status:{empty:__(
"No available test takers to assign"),available:__("Available test takers"),loading:__("Loading")},tools:[{id:"back",icon:"left",title:__("Return to the session manager"),label:__("Back"),action:function(){window.location.href=managerUrl}},{id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){$list.datatable("refresh")}},{id:"assign",icon:"add",title:__("Assign the selected test takers to the session"),label:__("Assign the selected test takers"),massAction:!0,action:function(selection){assign(selection)}}],actions:[{id:"assign",icon:"add",title:__("Assign the test taker to the session"),action:function(id){assign([id])
}}],selectable:!0,model:[{id:"firstname",label:__("First name")},{id:"lastname",label:__("Last name")},{id:"identifier",label:__("Identifier")}]},dataset)}}}),define("tpl!taoProctoring/templates/deliveryServer/authorizationSuccess",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="";return buffer+='<span class="success-message">',buffer+=(0,this.escapeExpression)((helper=helpers.message)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.message)?helper.call(depth0,{
hash:{},data:data}):helper)+'<span class="icon-result-ok"></span></span>'})}),define("tpl!taoProctoring/templates/deliveryServer/authorizationListBoxActions",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<span class="listbox-actions">\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.cancelable,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,options,buffer=""
;return buffer+='\n    <span class="action cancel js-cancel">\n        <span class="icon-stop"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Cancel",options):helperMissing.call(depth0,"__","Cancel",options)))+"\n    </span>\n    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n    <span class="action play js-proceed" data-delivery="',stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.id)?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
...
loadingBar,listBox,dialogAlert,polling,keepAfterResume,url,dialogConfirm,authSuccessTpl,listBoxActionsTpl){"use strict";return{start:function(config){var $container=$(".awaiting-authorization"),isAuthorizedUrl=helpers._url("isAuthorized","DeliveryServer","taoProctoring",{deliveryExecution:config.deliveryExecution}),runDeliveryUrl=config.runDeliveryUrl,boxes=[{id:"goToDelivery",label:config.deliveryLabel,url:runDeliveryUrl,content:__("Please wait, authorization in process ..."),html:listBoxActionsTpl({id:config.deliveryExecution,cancelable:config.cancelable})}],$content=(listBox({title:"",textEmpty:"",textNumber:"",textLoading:"",renderTo:$container,
list:boxes,width:12}),$container.find(".listbox .content")),deliveryStarted=!1,runDelivery=function(){loadingBar.start(),deliveryStarted=!0,window.location.href=runDeliveryUrl},isRunnable=function(){return!$container.hasClass("authorization-in-progress")&&!deliveryStarted};function exit(){window.location.href=config.returnUrl}keepAfterResume().reset(),loadingBar.start(!1),$container.on("click",".js-cancel",function(e){e.stopPropagation(),e.preventDefault(),dialogConfirm(__("Are you sure you want to end the test?"),function(){window.location.href=config.cancelUrl})}),$container.on("click",".js-proceed",function(e){return isRunnable()&&runDelivery(),!1}),
$container.on("click",".block.box",function(e){return isRunnable()&&runDelivery(),!1}),polling({action:function(){var async=this.async();$.get(isAuthorizedUrl,function(result){var stop=!1;result.success?result.authorized&&(stop=!0,$content.html(authSuccessTpl({message:__("Authorized, you may proceed")})),loadingBar.stop(),$container.addClass("authorization-granted").removeClass("authorization-in-progress")):(stop=!0,result.message?dialogAlert(result.message,exit):exit()),stop?async.reject():async.resolve()})},interval:1e4,autoStart:!0}).next()}}}),define("taoProctoring/controller/Irregularity/index",["jquery","lodash","i18n","ui/hider","util/url",
"ui/feedback","core/taskQueue/taskQueue","ui/taskQueueButton/standardButton"],function($,_,__,hider,urlHelper,feedback,taskQueue,taskCreationButtonFactory){"use strict";return{start:function(){var taskCreationButton,purpose,$header=$("header.section-header"),$formContainer=$(".print-form"),$reportContainer=$(".print-report"),$form=$("form",$formContainer),$submitter=$(".form-submitter",$form),$containers=$(".main-container");function refreshTree(){$(".tree").trigger("refresh.taotree",[{uri:$header.data("select-node")}])}purpose="form",hider.hide($containers),hider.show($containers.filter('[data-purpose="'+purpose+'"]')),
taskCreationButton=taskCreationButtonFactory({type:"info",icon:"export",title:__("Export Irregularities"),label:__("Export"),taskQueue:taskQueue,taskCreationUrl:$form.prop("action"),taskCreationData:function(){return $form.serializeArray()},taskReportContainer:$reportContainer}).on("finished",function(result){result.task&&result.task.report&&_.isArray(result.task.report.children)&&result.task.report.children.length&&result.task.report.children[0]&&(result.task.report.children[0].data&&result.task.report.children[0].data.uriResource?(feedback().info(__("%s completed",result.task.taskLabel)),refreshTree(result.task.report.children[0].data.uriResource)
):this.displayReport(result.task.report.children[0],__("Error")))}).on("continue",function(){refreshTree()}).on("error",function(err){feedback().error(err)}).render($submitter.closest(".form-toolbar")),$submitter.replaceWith(taskCreationButton.getElement().css({float:"right"}))}}}),define("tpl!taoProctoring/component/dateRange/form",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression
;return buffer+='<form class="daterange">\n    <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"From",options):helperMissing.call(depth0,"__","From",options)))+'</label><input type="text" name="periodStart" value="',buffer+=escapeExpression((helper=helpers.start)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.start)?helper.call(depth0,{hash:{},data:data}):helper)+'"/>\n    <label>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"to",options):helperMissing.call(depth0,"__","to",options))
)+'</label><input type="text" name="periodEnd" value="',buffer+=escapeExpression((helper=helpers.end)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.end)?helper.call(depth0,{hash:{},data:data}):helper)+'"/>\n    <button class="small info" data-control="filter"><span class="icon icon-filter"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Filter",options):helperMissing.call(depth0,"__","Filter",options)))+"</button>\n</form>"})}),define("jquery.timePicker",["jquery","jqueryui"],function(jQuery){var $=jQuery;if($.ui.timepicker=$.ui.timepicker||{},
!$.ui.timepicker.version){$.extend($.ui,{timepicker:{version:"1.3"}});var Timepicker=function(){this.regional=[],this.regional[""]={currentText:"Now",closeText:"Done",amNames:["AM","A"],pmNames:["PM","P"],timeFormat:"HH:mm",timeSuffix:"",timeOnlyTitle:"Choose Time",timeText:"Time",hourText:"Hour",minuteText:"Minute",secondText:"Second",millisecText:"Millisecond",microsecText:"Microsecond",timezoneText:"Time Zone",isRTL:!1},this._defaults={showButtonPanel:!0,timeOnly:!1,showHour:null,showMinute:null,showSecond:null,showMillisec:null,showMicrosec:null,showTimezone:null,showTime:!0,stepHour:1,stepMinute:1,stepSecond:1,stepMillisec:1,stepMicrosec:1,hour:0,
minute:0,second:0,millisec:0,microsec:0,timezone:null,hourMin:0,minuteMin:0,secondMin:0,millisecMin:0,microsecMin:0,hourMax:23,minuteMax:59,secondMax:59,millisecMax:999,microsecMax:999,minDateTime:null,maxDateTime:null,onSelect:null,hourGrid:0,minuteGrid:0,secondGrid:0,millisecGrid:0,microsecGrid:0,alwaysSetTime:!0,separator:" ",altFieldTimeOnly:!0,altTimeFormat:null,altSeparator:null,altTimeSuffix:null,pickerTimeFormat:null,pickerTimeSuffix:null,showTimepicker:!0,timezoneList:null,addSliderAccess:!1,sliderAccessArgs:null,controlType:"slider",defaultValue:null,parse:"strict"},$.extend(this._defaults,this.regional[""])};$.extend(Timepicker.prototype,{
...
return extendRemove(this._defaults,settings||{}),this},_newInst:function($input,o){var tp_inst=new Timepicker,inlineSettings={},fns={},overrides,i;for(var attrName in this._defaults)if(this._defaults.hasOwnProperty(attrName)){var attrValue=$input.attr("time:"+attrName);if(attrValue)try{inlineSettings[attrName]=eval(attrValue)}catch(err){inlineSettings[attrName]=attrValue}}for(i in overrides={beforeShow:function(input,dp_inst){if($.isFunction(tp_inst._defaults.evnts.beforeShow))return tp_inst._defaults.evnts.beforeShow.call($input[0],input,dp_inst,tp_inst)},onChangeMonthYear:function(year,month,dp_inst){tp_inst._updateDateTime(dp_inst),$.isFunction(
tp_inst._defaults.evnts.onChangeMonthYear)&&tp_inst._defaults.evnts.onChangeMonthYear.call($input[0],year,month,dp_inst,tp_inst)},onClose:function(dateText,dp_inst){!0===tp_inst.timeDefined&&""!==$input.val()&&tp_inst._updateDateTime(dp_inst),$.isFunction(tp_inst._defaults.evnts.onClose)&&tp_inst._defaults.evnts.onClose.call($input[0],dateText,dp_inst,tp_inst)}},overrides)overrides.hasOwnProperty(i)&&(fns[i]=o[i]||null);tp_inst._defaults=$.extend({},this._defaults,inlineSettings,o,overrides,{evnts:fns,timepicker:tp_inst}),tp_inst.amNames=$.map(tp_inst._defaults.amNames,function(val){return val.toUpperCase()}),tp_inst.pmNames=$.map(tp_inst._defaults.pmNames,
function(val){return val.toUpperCase()}),tp_inst.support=detectSupport(tp_inst._defaults.timeFormat+(tp_inst._defaults.pickerTimeFormat?tp_inst._defaults.pickerTimeFormat:"")+(tp_inst._defaults.altTimeFormat?tp_inst._defaults.altTimeFormat:"")),"string"==typeof tp_inst._defaults.controlType?("slider"==tp_inst._defaults.controlType&&void 0===jQuery.ui.slider&&(tp_inst._defaults.controlType="select"),tp_inst.control=tp_inst._controls[tp_inst._defaults.controlType]):tp_inst.control=tp_inst._defaults.controlType;var timezoneList=[-720,-660,-600,-570,-540,-480,-420,-360,-300,-270,-240,-210,-180,-120,-60,0,60,120,180,210,240,270,300,330,345,360,390,420,480,525,540
...
tp_inst.hour=tp_inst._defaults.hour<tp_inst._defaults.hourMin?tp_inst._defaults.hourMin:tp_inst._defaults.hour>tp_inst._defaults.hourMax?tp_inst._defaults.hourMax:tp_inst._defaults.hour,tp_inst.minute=tp_inst._defaults.minute<tp_inst._defaults.minuteMin?tp_inst._defaults.minuteMin:tp_inst._defaults.minute>tp_inst._defaults.minuteMax?tp_inst._defaults.minuteMax:tp_inst._defaults.minute,tp_inst.second=tp_inst._defaults.second<tp_inst._defaults.secondMin?tp_inst._defaults.secondMin:tp_inst._defaults.second>tp_inst._defaults.secondMax?tp_inst._defaults.secondMax:tp_inst._defaults.second,
tp_inst.millisec=tp_inst._defaults.millisec<tp_inst._defaults.millisecMin?tp_inst._defaults.millisecMin:tp_inst._defaults.millisec>tp_inst._defaults.millisecMax?tp_inst._defaults.millisecMax:tp_inst._defaults.millisec,tp_inst.microsec=tp_inst._defaults.microsec<tp_inst._defaults.microsecMin?tp_inst._defaults.microsecMin:tp_inst._defaults.microsec>tp_inst._defaults.microsecMax?tp_inst._defaults.microsecMax:tp_inst._defaults.microsec,tp_inst.ampm="",tp_inst.$input=$input,o.altField&&(tp_inst.$altInput=$(o.altField).css({cursor:"pointer"}).focus(function(){$input.trigger("focus")})),0!==tp_inst._defaults.minDate&&0!==tp_inst._defaults.minDateTime||(
tp_inst._defaults.minDate=new Date),0!==tp_inst._defaults.maxDate&&0!==tp_inst._defaults.maxDateTime||(tp_inst._defaults.maxDate=new Date),void 0!==tp_inst._defaults.minDate&&tp_inst._defaults.minDate instanceof Date&&(tp_inst._defaults.minDateTime=new Date(tp_inst._defaults.minDate.getTime())),void 0!==tp_inst._defaults.minDateTime&&tp_inst._defaults.minDateTime instanceof Date&&(tp_inst._defaults.minDate=new Date(tp_inst._defaults.minDateTime.getTime())),void 0!==tp_inst._defaults.maxDate&&tp_inst._defaults.maxDate instanceof Date&&(tp_inst._defaults.maxDateTime=new Date(tp_inst._defaults.maxDate.getTime())),
void 0!==tp_inst._defaults.maxDateTime&&tp_inst._defaults.maxDateTime instanceof Date&&(tp_inst._defaults.maxDate=new Date(tp_inst._defaults.maxDateTime.getTime())),tp_inst.$input.bind("focus",function(){tp_inst._onFocus()}),tp_inst},_addTimePicker:function(dp_inst){var currDT=this.$altInput&&this._defaults.altFieldTimeOnly?this.$input.val()+" "+this.$altInput.val():this.$input.val();this.timeDefined=this._parseTime(currDT),this._limitMinMaxDateTime(dp_inst,!1),this._injectTimePicker()},_parseTime:function(timeString,withDate){if(this.inst||(this.inst=$.datepicker._getInst(this.$input[0])),withDate||!this._defaults.timeOnly){
var dp_dateFormat=$.datepicker._get(this.inst,"dateFormat");try{var parseRes=parseDateTimeInternal(dp_dateFormat,this._defaults.timeFormat,timeString,$.datepicker._getFormatConfig(this.inst),this._defaults);if(!parseRes.timeObj)return!1;$.extend(this,parseRes.timeObj)}catch(err){return $.timepicker.log("Error parsing the date/time string: "+err+"\ndate/time string = "+timeString+"\ntimeFormat = "+this._defaults.timeFormat+"\ndateFormat = "+dp_dateFormat),!1}return!0}var timeObj=$.datepicker.parseTime(this._defaults.timeFormat,timeString,this._defaults);return!!timeObj&&($.extend(this,timeObj),!0)},_injectTimePicker:function(){var $dp=this.inst.dpDiv,
o=this.inst.settings,tp_inst=this,litem="",uitem="",show=null,max={},gridSize={},size=null,i=0,l=0;if(0===$dp.find("div.ui-timepicker-div").length&&o.showTimepicker){var noDisplay=' style="display:none;"',html='<div class="ui-timepicker-div'+(o.isRTL?" ui-timepicker-rtl":"")+'"><dl><dt class="ui_tpicker_time_label"'+(o.showTime?"":noDisplay)+">"+o.timeText+'</dt><dd class="ui_tpicker_time"'+(o.showTime?"":noDisplay)+"></dd>";for(i=0,l=this.units.length;i<l;i++){if(show=null!==o["show"+(uitem=(litem=this.units[i]).substr(0,1).toUpperCase()+litem.substr(1))]?o["show"+uitem]:this.support[litem],max[litem]=parseInt(o[litem+"Max"]-(o[litem+"Max"]-o[litem+"Min"]
)%o["step"+uitem],10),gridSize[litem]=0,html+='<dt class="ui_tpicker_'+litem+'_label"'+(show?"":noDisplay)+">"+o[litem+"Text"]+'</dt><dd class="ui_tpicker_'+litem+'"><div class="ui_tpicker_'+litem+'_slider"'+(show?"":noDisplay)+"></div>",show&&0<o[litem+"Grid"]){if(html+='<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>',"hour"==litem)for(var h=o[litem+"Min"];h<=max[litem];h+=parseInt(o[litem+"Grid"],10)){gridSize[litem]++;var tmph=$.datepicker.formatTime(this.support.ampm?"hht":"HH",{hour:h},o);html+='<td data-for="'+litem+'">'+tmph+"</td>"}else for(var m=o[litem+"Min"];m<=max[litem];m+=parseInt(o[litem+"Grid"],10))gridSize[litem]++,
...
litem=tp_inst.units[i]).substr(0,1).toUpperCase()+litem.substr(1))]?o["show"+uitem]:this.support[litem],tp_inst[litem+"_slider"]=tp_inst.control.create(tp_inst,$tp.find(".ui_tpicker_"+litem+"_slider"),litem,tp_inst[litem],o[litem+"Min"],max[litem],o["step"+uitem]),show&&0<o[litem+"Grid"]&&(size=100*gridSize[litem]*o[litem+"Grid"]/(max[litem]-o[litem+"Min"]),$tp.find(".ui_tpicker_"+litem+" table").css({width:size+"%",marginLeft:o.isRTL?"0":size/(-2*gridSize[litem])+"%",marginRight:o.isRTL?size/(-2*gridSize[litem])+"%":"0",borderCollapse:"collapse"}).find("td").click(function(e){var $t=$(this),h=$t.html(),n=parseInt(h.replace(/[^0-9]/g),10),ap=h.replace(
/[^apm]/gi),f=$t.data("for");"hour"==f&&(-1!==ap.indexOf("p")&&n<12?n+=12:-1!==ap.indexOf("a")&&12===n&&(n=0)),tp_inst.control.value(tp_inst,tp_inst[f+"_slider"],litem,n),tp_inst._onTimeChange(),tp_inst._onSelectHandler()}).css({cursor:"pointer",width:100/gridSize[litem]+"%",textAlign:"center",overflow:"hidden"}));if(this.timezone_select=$tp.find(".ui_tpicker_timezone").append("<select></select>").find("select"),$.fn.append.apply(this.timezone_select,$.map(o.timezoneList,function(val,idx){return $("<option />").val("object"==typeof val?val.value:val).text("object"==typeof val?val.label:val)})),void 0!==this.timezone&&null!==this.timezone&&""!==this.timezone
)-1*new Date(this.inst.selectedYear,this.inst.selectedMonth,this.inst.selectedDay,12).getTimezoneOffset()==this.timezone?selectLocalTimezone(tp_inst):this.timezone_select.val(this.timezone);else void 0!==this.hour&&null!==this.hour&&""!==this.hour?this.timezone_select.val(o.timezone):selectLocalTimezone(tp_inst);this.timezone_select.change(function(){tp_inst._onTimeChange(),tp_inst._onSelectHandler()});var $buttonPanel=$dp.find(".ui-datepicker-buttonpane");if($buttonPanel.length?$buttonPanel.before($tp):$dp.append($tp),this.$timeObj=$tp.find(".ui_tpicker_time"),null!==this.inst){var timeDefined=this.timeDefined;this._onTimeChange(),
this.timeDefined=timeDefined}if(this._defaults.addSliderAccess){var sliderAccessArgs=this._defaults.sliderAccessArgs,rtl=this._defaults.isRTL;sliderAccessArgs.isRTL=rtl,setTimeout(function(){if(0===$tp.find(".ui-slider-access").length){$tp.find(".ui-slider:visible").sliderAccess(sliderAccessArgs);var sliderAccessWidth=$tp.find(".ui-slider-access:eq(0)").outerWidth(!0);sliderAccessWidth&&$tp.find("table:visible").each(function(){var $g=$(this),oldWidth=$g.outerWidth(),oldMarginLeft=$g.css(rtl?"marginRight":"marginLeft").toString().replace("%",""),newWidth=oldWidth-sliderAccessWidth,newMarginLeft=oldMarginLeft*newWidth/oldWidth+"%",css={width:newWidth,
marginRight:0,marginLeft:0};css[rtl?"marginRight":"marginLeft"]=newMarginLeft,$g.css(css)})}},10)}}},_limitMinMaxDateTime:function(dp_inst,adjustSliders){var o=this._defaults,dp_date=new Date(dp_inst.selectedYear,dp_inst.selectedMonth,dp_inst.selectedDay);if(this._defaults.showTimepicker){if(null!==$.datepicker._get(dp_inst,"minDateTime")&&void 0!==$.datepicker._get(dp_inst,"minDateTime")&&dp_date){var minDateTime=$.datepicker._get(dp_inst,"minDateTime"),minDateTimeDate=new Date(minDateTime.getFullYear(),minDateTime.getMonth(),minDateTime.getDate(),0,0,0,0)
...
this._defaults.secondMin=minDateTime.getSeconds(),this.second<=this._defaults.secondMin?(this.second=this._defaults.secondMin,this._defaults.millisecMin=minDateTime.getMilliseconds(),this.millisec<=this._defaults.millisecMin?(this.millisec=this._defaults.millisecMin,this._defaults.microsecMin=minDateTime.getMicroseconds()):(this.microsec<this._defaults.microsecMin&&(this.microsec=this._defaults.microsecMin),this._defaults.microsecMin=this.microsecMinOriginal)):(this._defaults.millisecMin=this.millisecMinOriginal,this._defaults.microsecMin=this.microsecMinOriginal)):(this._defaults.secondMin=this.secondMinOriginal,
this._defaults.millisecMin=this.millisecMinOriginal,this._defaults.microsecMin=this.microsecMinOriginal)):(this._defaults.minuteMin=this.minuteMinOriginal,this._defaults.secondMin=this.secondMinOriginal,this._defaults.millisecMin=this.millisecMinOriginal,this._defaults.microsecMin=this.microsecMinOriginal)):(this._defaults.hourMin=this.hourMinOriginal,this._defaults.minuteMin=this.minuteMinOriginal,this._defaults.secondMin=this.secondMinOriginal,this._defaults.millisecMin=this.millisecMinOriginal,this._defaults.microsecMin=this.microsecMinOriginal)}if(null!==$.datepicker._get(dp_inst,"maxDateTime")&&void 0!==$.datepicker._get(dp_inst,"maxDateTime")&&dp_date
){var maxDateTime=$.datepicker._get(dp_inst,"maxDateTime"),maxDateTimeDate=new Date(maxDateTime.getFullYear(),maxDateTime.getMonth(),maxDateTime.getDate(),0,0,0,0);null!==this.hourMaxOriginal&&null!==this.minuteMaxOriginal&&null!==this.secondMaxOriginal&&null!==this.millisecMaxOriginal||(this.hourMaxOriginal=o.hourMax,this.minuteMaxOriginal=o.minuteMax,this.secondMaxOriginal=o.secondMax,this.millisecMaxOriginal=o.millisecMax,this.microsecMaxOriginal=o.microsecMax),dp_inst.settings.timeOnly||maxDateTimeDate.getTime()==dp_date.getTime()?(this._defaults.hourMax=maxDateTime.getHours(),this.hour>=this._defaults.hourMax?(this.hour=this._defaults.hourMax,
this._defaults.minuteMax=maxDateTime.getMinutes(),this.minute>=this._defaults.minuteMax?(this.minute=this._defaults.minuteMax,this._defaults.secondMax=maxDateTime.getSeconds(),this.second>=this._defaults.secondMax?(this.second=this._defaults.secondMax,this._defaults.millisecMax=maxDateTime.getMilliseconds(),this.millisec>=this._defaults.millisecMax?(this.millisec=this._defaults.millisecMax,this._defaults.microsecMax=maxDateTime.getMicroseconds()):(this.microsec>this._defaults.microsecMax&&(this.microsec=this._defaults.microsecMax),this._defaults.microsecMax=this.microsecMaxOriginal)):(this._defaults.millisecMax=this.millisecMaxOriginal,
this._defaults.microsecMax=this.microsecMaxOriginal)):(this._defaults.secondMax=this.secondMaxOriginal,this._defaults.millisecMax=this.millisecMaxOriginal,this._defaults.microsecMax=this.microsecMaxOriginal)):(this._defaults.minuteMax=this.minuteMaxOriginal,this._defaults.secondMax=this.secondMaxOriginal,this._defaults.millisecMax=this.millisecMaxOriginal,this._defaults.microsecMax=this.microsecMaxOriginal)):(this._defaults.hourMax=this.hourMaxOriginal,this._defaults.minuteMax=this.minuteMaxOriginal,this._defaults.secondMax=this.secondMaxOriginal,this._defaults.millisecMax=this.millisecMaxOriginal,this._defaults.microsecMax=this.microsecMaxOriginal)}if(
void 0!==adjustSliders&&!0===adjustSliders){var hourMax=parseInt(this._defaults.hourMax-(this._defaults.hourMax-this._defaults.hourMin)%this._defaults.stepHour,10),minMax=parseInt(this._defaults.minuteMax-(this._defaults.minuteMax-this._defaults.minuteMin)%this._defaults.stepMinute,10),secMax=parseInt(this._defaults.secondMax-(this._defaults.secondMax-this._defaults.secondMin)%this._defaults.stepSecond,10),millisecMax=parseInt(this._defaults.millisecMax-(this._defaults.millisecMax-this._defaults.millisecMin)%this._defaults.stepMillisec,10);microsecMax=parseInt(this._defaults.microsecMax-(this._defaults.microsecMax-this._defaults.microsecMin
)%this._defaults.stepMicrosec,10),this.hour_slider&&(this.control.options(this,this.hour_slider,"hour",{min:this._defaults.hourMin,max:hourMax}),this.control.value(this,this.hour_slider,"hour",this.hour-this.hour%this._defaults.stepHour)),this.minute_slider&&(this.control.options(this,this.minute_slider,"minute",{min:this._defaults.minuteMin,max:minMax}),this.control.value(this,this.minute_slider,"minute",this.minute-this.minute%this._defaults.stepMinute)),this.second_slider&&(this.control.options(this,this.second_slider,"second",{min:this._defaults.secondMin,max:secMax}),this.control.value(this,this.second_slider,"second",
this.second-this.second%this._defaults.stepSecond)),this.millisec_slider&&(this.control.options(this,this.millisec_slider,"millisec",{min:this._defaults.millisecMin,max:millisecMax}),this.control.value(this,this.millisec_slider,"millisec",this.millisec-this.millisec%this._defaults.stepMillisec)),this.microsec_slider&&(this.control.options(this,this.microsec_slider,"microsec",{min:this._defaults.microsecMin,max:microsecMax}),this.control.value(this,this.microsec_slider,"microsec",this.microsec-this.microsec%this._defaults.stepMicrosec))}}},_onTimeChange:function(){var hour=!!this.hour_slider&&this.control.value(this,this.hour_slider,"hour"),
minute=!!this.minute_slider&&this.control.value(this,this.minute_slider,"minute"),second=!!this.second_slider&&this.control.value(this,this.second_slider,"second"),millisec=!!this.millisec_slider&&this.control.value(this,this.millisec_slider,"millisec"),microsec=!!this.microsec_slider&&this.control.value(this,this.microsec_slider,"microsec"),timezone=!!this.timezone_select&&this.timezone_select.val(),o=this._defaults,pickerTimeFormat=o.pickerTimeFormat||o.timeFormat,pickerTimeSuffix=o.pickerTimeSuffix||o.timeSuffix;"object"==typeof hour&&(hour=!1),"object"==typeof minute&&(minute=!1),"object"==typeof second&&(second=!1),"object"==typeof millisec&&(
millisec=!1),"object"==typeof microsec&&(microsec=!1),"object"==typeof timezone&&(timezone=!1),!1!==hour&&(hour=parseInt(hour,10)),!1!==minute&&(minute=parseInt(minute,10)),!1!==second&&(second=parseInt(second,10)),!1!==millisec&&(millisec=parseInt(millisec,10)),!1!==microsec&&(microsec=parseInt(microsec,10));var ampm=o[hour<12?"amNames":"pmNames"][0],hasChanged=hour!=this.hour||minute!=this.minute||second!=this.second||millisec!=this.millisec||microsec!=this.microsec||0<this.ampm.length&&hour<12!=(-1!==$.inArray(this.ampm.toUpperCase(),this.amNames))||null!==this.timezone&&timezone!=this.timezone;hasChanged&&(!1!==hour&&(this.hour=hour),!1!==minute&&(
this.minute=minute),!1!==second&&(this.second=second),!1!==millisec&&(this.millisec=millisec),!1!==microsec&&(this.microsec=microsec),!1!==timezone&&(this.timezone=timezone),this.inst||(this.inst=$.datepicker._getInst(this.$input[0])),this._limitMinMaxDateTime(this.inst,!0)),this.support.ampm&&(this.ampm=ampm),this.formattedTime=$.datepicker.formatTime(o.timeFormat,this,o),this.$timeObj&&(pickerTimeFormat===o.timeFormat?this.$timeObj.text(this.formattedTime+pickerTimeSuffix):this.$timeObj.text($.datepicker.formatTime(pickerTimeFormat,this,o)+pickerTimeSuffix)),this.timeDefined=!0,hasChanged&&this._updateDateTime()},_onSelectHandler:function(){
...
dp_inst.currentYear=dp_inst.selectedYear,dp_inst.currentMonth=dp_inst.selectedMonth,dp_inst.currentDay=dp_inst.selectedDay),!0===this._defaults.timeOnly?formattedDateTime=this.formattedTime:!0!==this._defaults.timeOnly&&(this._defaults.alwaysSetTime||timeAvailable)&&(formattedDateTime+=this._defaults.separator+this.formattedTime+this._defaults.timeSuffix),this.formattedDateTime=formattedDateTime,this._defaults.showTimepicker)if(this.$altInput&&!1===this._defaults.timeOnly&&!0===this._defaults.altFieldTimeOnly)this.$altInput.val(this.formattedTime),this.$input.val(this.formattedDate);else if(this.$altInput){this.$input.val(formattedDateTime)
;var altFormattedDateTime="",altSeparator=this._defaults.altSeparator?this._defaults.altSeparator:this._defaults.separator,altTimeSuffix=this._defaults.altTimeSuffix?this._defaults.altTimeSuffix:this._defaults.timeSuffix;this._defaults.timeOnly||(altFormattedDateTime=this._defaults.altFormat?$.datepicker.formatDate(this._defaults.altFormat,null===dt?new Date:dt,formatCfg):this.formattedDate)&&(altFormattedDateTime+=altSeparator),this._defaults.altTimeFormat?altFormattedDateTime+=$.datepicker.formatTime(this._defaults.altTimeFormat,this,this._defaults)+altTimeSuffix:altFormattedDateTime+=this.formattedTime+altTimeSuffix,this.$altInput.val(altFormattedDateTime
...
min:rtl?-1*max:min,max:rtl?-1*min:max,step:step,slide:function(event,ui){tp_inst.control.value(tp_inst,$(this),unit,rtl?-1*ui.value:ui.value),tp_inst._onTimeChange()},stop:function(event,ui){tp_inst._onSelectHandler()}})},options:function(tp_inst,obj,unit,opts,val){if(tp_inst._defaults.isRTL){if("string"==typeof opts)return"min"==opts||"max"==opts?void 0!==val?obj.slider(opts,-1*val):Math.abs(obj.slider(opts)):obj.slider(opts);var min=opts.min,max=opts.max;return opts.min=opts.max=null,void 0!==min&&(opts.max=-1*min),void 0!==max&&(opts.min=-1*max),obj.slider(opts)}return"string"==typeof opts&&void 0!==val?obj.slider(opts,val):obj.slider(opts)},
value:function(tp_inst,obj,unit,val){return tp_inst._defaults.isRTL?void 0!==val?obj.slider("value",-1*val):Math.abs(obj.slider("value")):void 0!==val?obj.slider("value",val):obj.slider("value")}},select:{create:function(tp_inst,obj,unit,val,min,max,step){for(var sel='<select class="ui-timepicker-select" data-unit="'+unit+'" data-min="'+min+'" data-max="'+max+'" data-step="'+step+'">',format=tp_inst._defaults.pickerTimeFormat||tp_inst._defaults.timeFormat,i=min;i<=max;i+=step)sel+='<option value="'+i+'"'+(i==val?" selected":"")+">",sel+="hour"==unit?$.datepicker.formatTime($.trim(format.replace(/[^ht ]/gi,"")),{hour:i},tp_inst._defaults
):"millisec"==unit||"microsec"==unit||10<=i?i:"0"+i.toString(),sel+="</option>";return sel+="</select>",obj.children("select").remove(),$(sel).appendTo(obj).change(function(e){tp_inst._onTimeChange(),tp_inst._onSelectHandler()}),obj},options:function(tp_inst,obj,unit,opts,val){var o={},$t=obj.children("select");if("string"==typeof opts){if(void 0===val)return $t.data(opts);o[opts]=val}else o=opts;return tp_inst.control.create(tp_inst,obj,$t.data("unit"),$t.val(),o.min||$t.data("min"),o.max||$t.data("max"),o.step||$t.data("step"))},value:function(tp_inst,obj,unit,val){var $t=obj.children("select");return void 0!==val?$t.val(val):$t.val()}}}}),$.fn.extend({
timepicker:function(o){o=o||{};var tmp_args=Array.prototype.slice.call(arguments);return"object"==typeof o&&(tmp_args[0]=$.extend(o,{timeOnly:!0})),$(this).each(function(){$.fn.datetimepicker.apply($(this),tmp_args)})},datetimepicker:function(o){var tmp_args=arguments;return"string"==typeof(o=o||{})?"getDate"==o?$.fn.datepicker.apply($(this[0]),tmp_args):this.each(function(){var $t=$(this);$t.datepicker.apply($t,tmp_args)}):this.each(function(){var $t=$(this);$t.datepicker($.timepicker._newInst($t,o)._defaults)})}}),$.datepicker.parseDateTime=function(dateFormat,timeFormat,dateTimeString,dateSettings,timeSettings){var parseRes=parseDateTimeInternal(
dateFormat,timeFormat,dateTimeString,dateSettings,timeSettings);if(parseRes.timeObj){var t=parseRes.timeObj;parseRes.date.setHours(t.hour,t.minute,t.second,t.millisec),parseRex.date.setMicroseconds(t.microsec)}return parseRes.date},$.datepicker.parseTime=function(timeFormat,timeString,options){var o=extendRemove(extendRemove({},$.timepicker._defaults),options||{}),strictParse=(timeFormat.replace(/\'.*?\'/g,"").indexOf("Z"),function(f,s,o){var treg,regstr="^"+f.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(match){var amNames,pmNames,markers,ml=match.length;switch(match.charAt(0).toLowerCase()){case"h":case"m":case"s":
return 1===ml?"(\\d?\\d)":"(\\d{"+ml+"})";case"l":case"c":return"(\\d?\\d?\\d)";case"z":return"(z|[-+]\\d\\d:?\\d\\d|\\S+)?";case"t":return amNames=o.amNames,pmNames=o.pmNames,markers=[],amNames&&$.merge(markers,amNames),pmNames&&$.merge(markers,pmNames),"("+(markers=$.map(markers,function(val){return val.replace(/[.*+?|()\[\]{}\\]/g,"\\$&")})).join("|")+")?";default:return"("+match.replace(/\'/g,"").replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g,function(m){return"\\"+m})+")?"}}).replace(/\s/g,"\\s?")+o.timeSuffix+"$",order=function(timeFormat){var finds=timeFormat.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g),orders={h:-1,m:-1,
s:-1,l:-1,c:-1,t:-1,z:-1};if(finds)for(var i=0;i<finds.length;i++)-1==orders[finds[i].toString().charAt(0)]&&(orders[finds[i].toString().charAt(0)]=i+1);return orders}(f),ampm="",resTime={hour:0,minute:0,second:0,millisec:0,microsec:0};return!!(treg=s.match(new RegExp(regstr,"i")))&&(-1!==order.t&&(void 0===treg[order.t]||0===treg[order.t].length?(ampm="",resTime.ampm=""):(ampm=-1!==$.inArray(treg[order.t].toUpperCase(),o.amNames)?"AM":"PM",resTime.ampm=o["AM"==ampm?"amNames":"pmNames"][0])),-1!==order.h&&("AM"==ampm&&"12"==treg[order.h]?resTime.hour=0:"PM"==ampm&&"12"!=treg[order.h]?resTime.hour=parseInt(treg[order.h],10)+12:resTime.hour=Number(
treg[order.h])),-1!==order.m&&(resTime.minute=Number(treg[order.m])),-1!==order.s&&(resTime.second=Number(treg[order.s])),-1!==order.l&&(resTime.millisec=Number(treg[order.l])),-1!==order.c&&(resTime.microsec=Number(treg[order.c])),-1!==order.z&&void 0!==treg[order.z]&&(resTime.timezone=$.timepicker.timezoneOffsetNumber(treg[order.z])),resTime)});return"function"==typeof o.parse?o.parse(timeFormat,timeString,o):"loose"===o.parse?function(f,s,o){try{var d=new Date("2012-01-01 "+s);if(isNaN(d.getTime())&&(d=new Date("2012-01-01T"+s),isNaN(d.getTime())&&(d=new Date("01/01/2012 "+s),isNaN(d.getTime()))))throw"Unable to parse time with native Date: "+s;return{
hour:d.getHours(),minute:d.getMinutes(),second:d.getSeconds(),millisec:d.getMilliseconds(),microsec:d.getMicroseconds(),timezone:-1*d.getTimezoneOffset()}}catch(err){try{return strictParse(f,s,o)}catch(err2){$.timepicker.log("Unable to parse \ntimeString: "+s+"\ntimeFormat: "+f)}}return!1}(timeFormat,timeString,o):strictParse(timeFormat,timeString,o)},$.datepicker.formatTime=function(format,time,options){options=options||{},options=$.extend({},$.timepicker._defaults,options),time=$.extend({hour:0,minute:0,second:0,millisec:0,timezone:0},time);var tmptime=format,ampmName=options.amNames[0],hour=parseInt(time.hour,10);return 11<hour&&(
ampmName=options.pmNames[0]),tmptime=tmptime.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|('.*?'|".*?"))/g,function(match){switch(match){case"HH":return("0"+hour).slice(-2);case"H":return hour;case"hh":return("0"+convert24to12(hour)).slice(-2);case"h":return convert24to12(hour);case"mm":return("0"+time.minute).slice(-2);case"m":return time.minute;case"ss":return("0"+time.second).slice(-2);case"s":return time.second;case"l":return("00"+time.millisec).slice(-3);case"c":return("00"+time.microsec).slice(-3);case"z":return $.timepicker.timezoneOffsetString(null===time.timezone?options.timezone:time.timezone,!1);case"Z":return $.timepicker.timezoneOffsetString(
null===time.timezone?options.timezone:time.timezone,!0);case"T":return ampmName.charAt(0).toUpperCase();case"TT":return ampmName.toUpperCase();case"t":return ampmName.charAt(0).toLowerCase();case"tt":return ampmName.toLowerCase();default:return match.replace(/\'/g,"")||"'"}}),tmptime=$.trim(tmptime)},$.datepicker._base_selectDate=$.datepicker._selectDate,$.datepicker._selectDate=function(id,dateStr){var inst=this._getInst($(id)[0]),tp_inst=this._get(inst,"timepicker");tp_inst?(tp_inst._limitMinMaxDateTime(inst,!0),inst.inline=inst.stay_open=!0,this._base_selectDate(id,dateStr),inst.inline=inst.stay_open=!1,this._notifyChange(inst),this._updateDatepicker(inst
)):this._base_selectDate(id,dateStr)},$.datepicker._base_updateDatepicker=$.datepicker._updateDatepicker,$.datepicker._updateDatepicker=function(inst){var input=inst.input[0];if(!($.datepicker._curInst&&$.datepicker._curInst!=inst&&$.datepicker._datepickerShowing&&$.datepicker._lastInput!=input||"boolean"==typeof inst.stay_open&&!1!==inst.stay_open)){this._base_updateDatepicker(inst);var tp_inst=this._get(inst,"timepicker");tp_inst&&tp_inst._addTimePicker(inst)}},$.datepicker._base_doKeyPress=$.datepicker._doKeyPress,$.datepicker._doKeyPress=function(event){var inst=$.datepicker._getInst(event.target),tp_inst=$.datepicker._get(inst,"timepicker");if(
tp_inst&&$.datepicker._get(inst,"constrainInput")){var ampm=tp_inst.support.ampm,tz=null!==tp_inst._defaults.showTimezone?tp_inst._defaults.showTimezone:tp_inst.support.timezone,dateChars=$.datepicker._possibleChars($.datepicker._get(inst,"dateFormat")),datetimeChars=tp_inst._defaults.timeFormat.toString().replace(/[hms]/g,"").replace(/TT/g,ampm?"APM":"").replace(/Tt/g,ampm?"AaPpMm":"").replace(/tT/g,ampm?"AaPpMm":"").replace(/T/g,ampm?"AP":"").replace(/tt/g,ampm?"apm":"").replace(/t/g,ampm?"ap":"")+" "+tp_inst._defaults.separator+tp_inst._defaults.timeSuffix+(tz?tp_inst._defaults.timezoneList.join(""):"")+tp_inst._defaults.amNames.join(""
)+tp_inst._defaults.pmNames.join("")+dateChars,chr=String.fromCharCode(void 0===event.charCode?event.keyCode:event.charCode);return event.ctrlKey||chr<" "||!dateChars||-1<datetimeChars.indexOf(chr)}return $.datepicker._base_doKeyPress(event)},$.datepicker._base_updateAlternate=$.datepicker._updateAlternate,$.datepicker._updateAlternate=function(inst){var tp_inst=this._get(inst,"timepicker");if(tp_inst){var altField=tp_inst._defaults.altField;if(altField){tp_inst._defaults.altFormat||tp_inst._defaults.dateFormat;var date=this._getDate(inst),formatCfg=$.datepicker._getFormatConfig(inst),altFormattedDateTime="",
altSeparator=tp_inst._defaults.altSeparator?tp_inst._defaults.altSeparator:tp_inst._defaults.separator,altTimeSuffix=tp_inst._defaults.altTimeSuffix?tp_inst._defaults.altTimeSuffix:tp_inst._defaults.timeSuffix,altTimeFormat=null!==tp_inst._defaults.altTimeFormat?tp_inst._defaults.altTimeFormat:tp_inst._defaults.timeFormat;altFormattedDateTime+=$.datepicker.formatTime(altTimeFormat,tp_inst,tp_inst._defaults)+altTimeSuffix,tp_inst._defaults.timeOnly||tp_inst._defaults.altFieldTimeOnly||null===date||(altFormattedDateTime=tp_inst._defaults.altFormat?$.datepicker.formatDate(tp_inst._defaults.altFormat,date,formatCfg
)+altSeparator+altFormattedDateTime:tp_inst.formattedDate+altSeparator+altFormattedDateTime),$(altField).val(altFormattedDateTime)}}else $.datepicker._base_updateAlternate(inst)},$.datepicker._base_doKeyUp=$.datepicker._doKeyUp,$.datepicker._doKeyUp=function(event){var inst=$.datepicker._getInst(event.target),tp_inst=$.datepicker._get(inst,"timepicker");if(tp_inst&&tp_inst._defaults.timeOnly&&inst.input.val()!=inst.lastVal)try{$.datepicker._updateDatepicker(inst)}catch(err){$.timepicker.log(err)}return $.datepicker._base_doKeyUp(event)},$.datepicker._base_gotoToday=$.datepicker._gotoToday,$.datepicker._gotoToday=function(id){var inst=this._getInst($(id)[0]),
$dp=inst.dpDiv;this._base_gotoToday(id);var tp_inst=this._get(inst,"timepicker");selectLocalTimezone(tp_inst);var now=new Date;this._setTime(inst,now),$(".ui-datepicker-today",$dp).click()},$.datepicker._disableTimepickerDatepicker=function(target){var inst=this._getInst(target);if(inst){var tp_inst=this._get(inst,"timepicker");$(target).datepicker("getDate"),tp_inst&&(tp_inst._defaults.showTimepicker=!1,tp_inst._updateDateTime(inst))}},$.datepicker._enableTimepickerDatepicker=function(target){var inst=this._getInst(target);if(inst){var tp_inst=this._get(inst,"timepicker");$(target).datepicker("getDate"),tp_inst&&(tp_inst._defaults.showTimepicker=!0,
...
startTime,endTime,"minDate"),selected(endTime,startTime,"maxDate"),$([startTime.get(0),endTime.get(0)])},$.timepicker.log=function(err){window.console&&console.log(err)},Date.prototype.getMicroseconds||(Date.microseconds=0,Date.prototype.getMicroseconds=function(){return this.microseconds},Date.prototype.setMicroseconds=function(m){return this.microseconds=m,this}),$.timepicker.version="1.3"}}),define("taoProctoring/component/dateRange",["jquery","lodash","ui/component","tpl!taoProctoring/component/dateRange/form","util/locale","jquery.timePicker"],function($,_,component,formTpl,locale){"use strict";var dateFormatStr=locale.getDateTimeFormat().split(" ")[0],
_defaults={dateFormat:dateFormatStr=(dateFormatStr=(dateFormatStr=dateFormatStr.replace("YYYY","yy")).replace("MM","mm")).replace("DD","dd")};return function(config){var initConfig=_.defaults(config||{},_defaults),periodStart=initConfig.start||"",periodEnd=initConfig.end||"",dateRange={getStart:function(){return periodStart},getEnd:function(){return periodEnd}};return initConfig.start=periodStart,initConfig.end=periodEnd,component(dateRange).setTemplate(formTpl).on("render",function(){var self=this,$form=this.getElement(),$periodStart=$form.find("input[name=periodStart]"),$periodEnd=$form.find("input[name=periodEnd]"),$filterBtn=$form.find(
'[data-control="filter"]');$periodStart.datepicker({dateFormat:initConfig.dateFormat,autoSize:!0}).change(function(){periodStart=$periodStart.val(),$periodEnd.datepicker("option","minDate",periodStart),self.trigger("change","start",periodStart)}),$periodEnd.datepicker({dateFormat:initConfig.dateFormat,autoSize:!0}).change(function(){periodEnd=$periodEnd.val(),$periodStart.datepicker("option","maxDate",periodEnd),self.trigger("change","end",periodEnd)}),$filterBtn.on("click",function(event){event.preventDefault(),periodStart=$periodStart.val(),periodEnd=$periodEnd.val(),self.trigger("submit")})}).init(initConfig)}}),define(
"taoProctoring/component/history/historyTable",["jquery","lodash","i18n","ui/component","ui/datatable"],function($,_,__,component){"use strict";var _defaults={sortBy:"timestamp",sortOrder:"desc"};function renderDetails(details){return _.isArray(details)&&(details=details.join("<br />")),details}return function(config,data){var initConfig=_.defaults(config||{},_defaults);return component({refresh:function(params){var $element;this.is("rendered")?($element=this.getElement(),params&&$element.datatable("options",{params:params}),$element.datatable("refresh")):params&&(initConfig.params=_.merge(initConfig.params,params))}}).on("render",function(){var self=this,
tools=[{id:"refresh",icon:"reset",title:__("Refresh the page"),label:__("Refresh"),action:function(){self.refresh()}}];this.getElement().on("query.datatable",function(){self.trigger("loading")}).on("load.datatable",function(){self.trigger("loaded")}).on("error.datatable",function(e,err){self.trigger("error",err)}).datatable({url:initConfig.service,params:initConfig.params,sortby:initConfig.sortBy,sortorder:initConfig.sortOrder,status:{empty:__("No history to display!"),available:__("Available history"),loading:__("Loading")},selectable:!(!initConfig.tools||!_.find(initConfig.tools,{massAction:!0})),tools:tools.concat(initConfig.tools||[]),model:[{id:"date",
label:__("Date"),sortable:!0},{id:"role",label:__("Role"),sortable:!0},{id:"actor",label:__("Actor"),sortable:!0},{id:"event",label:__("Event"),sortable:!0},{id:"details",label:__("Details"),transform:renderDetails},{id:"context",label:__("Context"),transform:renderDetails}]},data)}).init(initConfig)}}),define("tpl!taoProctoring/templates/reporting/index",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression
;return buffer+='<div class="content">\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+="<h1>",stack1=(helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</h1>"},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n    <div class="panel"></div>\n    <div class="list clearfix"></div>\n</div>\n'})}),define("taoProctoring/controller/Reporting/history",["lodash","i18n","util/url",
"controller/app","layout/loading-bar","ui/container","ui/button","util/encode","taoProctoring/component/proxy","taoProctoring/component/dateRange","taoProctoring/component/history/historyTable","tpl!taoProctoring/templates/reporting/index","ui/datatable"],function(_,__,urlHelper,appController,loadingBar,containerFactory,buttonFactory,encode,proxyFactory,dateRangeFactory,historyTableFactory,indexTpl){"use strict";var serviceUrl=urlHelper.route("sessionHistory","Reporting","taoProctoring"),sessionsUrl=urlHelper.route("history","Reporting","taoProctoring");return loadingBar.start(),{start:function(){var container=containerFactory().changeScope(
".session-history").write(indexTpl()),currentRoute=urlHelper.parse(window.location.href),context=currentRoute.query.context&&decodeURIComponent(currentRoute.query.context),deliveryId=currentRoute.query.delivery&&decodeURIComponent(currentRoute.query.delivery),sessions=decodeURIComponent(currentRoute.query.session).split(","),monitoringUrl=currentRoute.query.monitoring&&decodeURIComponent(currentRoute.query.monitoring);appController.on("set-referrer.history",function(route){monitoringUrl=route}).on("change.history",function(){appController.off(".history"),container.destroy()}),proxyFactory("ajax").init({actions:{read:serviceUrl}}).then(function(proxyService){
return proxyService.read({delivery:deliveryId,context:context,session:sessions}).then(function(data){var detailedHistory=data.detailedHistory,historyTable=historyTableFactory({tools:[{id:"show-detailed-report",icon:"insert-horizontal-line",title:__("Show detailed session history messages"),label:__("Show detailed report"),action:function(){var tool=_.find(historyTable.config.tools,{id:"show-detailed-report"});historyTable.config.params.detailed=detailedHistory=!detailedHistory,tool.label=__(detailedHistory?"Show brief report":"Show detailed report"),historyTable.refresh()}}],params:{detailed:detailedHistory,delivery:deliveryId,context:context,
session:sessions},service:sessionsUrl,sortBy:data.sortBy,sortOrder:data.sortOrder},data.set).on("loading",function(){loadingBar.start()}).on("loaded",function(){loadingBar.stop()}).on("error",function(err){appController.onError(err)}).render(container.find(".list"));data.monitoringUrl&&(monitoringUrl=data.monitoringUrl),dateRangeFactory({start:data.periodStart,end:data.periodEnd,renderTo:container.find(".panel")}).on("change submit",function(){historyTable.refresh({periodStart:this.getStart(),periodEnd:this.getEnd()})}),buttonFactory({id:"back",type:"info",label:__("Back to sessions"),cls:"back-button",renderTo:container.find(".panel")}).on("click",function(
){monitoringUrl?appController.getRouter().redirect(monitoringUrl):history.go(-1)})})}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/controller/routes",{Reporting:{actions:{index:"controller/Reporting/history"}},Irregularity:{actions:{index:"controller/Irregularity/index"}},DeliverySelection:{actions:{index:"controller/Delivery/index"}},Monitor:{actions:{index:"controller/Delivery/monitoring"}},Tools:{css:"tools",actions:{assessmentActivity:"controller/Tools/assessmentActivity"}}}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock",["handlebars"],function(hb){
return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="col-',buffer+=escapeExpression((helper=helpers.size)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.size)?helper.call(depth0,{hash:{},data:data}):helper)+' dashboard-block">\n        <span class="dashboard-block-number ',buffer+=escapeExpression((helper=helpers.container)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.container)?helper.call(
depth0,{hash:{},data:data}):helper)+'">\n            ',buffer+=escapeExpression((helper=helpers.value)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.value)?helper.call(depth0,{hash:{},data:data}):helper)+'\n        </span>\n    <h3>\n        <span class="icon icon-test-',buffer+=escapeExpression((helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.icon)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\n        ',buffer+=escapeExpression((helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,
{hash:{},data:data}):helper)+"\n    </h3>\n</div>"})}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivity",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),data=data||{};var stack1,buffer="",self=this;return buffer+="<div>\n    ",((stack1=helpers.each.call(depth0,depth0,{hash:{},inverse:self.noop,fn:self.program(1,function(depth0,data){var stack1,buffer="";return buffer+="\n    ",((stack1=self.invokePartial(partials["ui-activity-widget-group"],
"ui-activity-widget-group",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+="\n    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n</div>"})}),define("taoProctoring/component/activityMonitoring/userActivity/userActivity",["jquery","lodash","i18n","ui/component","handlebars","tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock","tpl!taoProctoring/component/activityMonitoring/userActivity/userActivity"],function($,_,__,component,Handlebars,groupTpl,componentTpl){"use strict";var _defaults={activeProctors:{container:"active-proctors",label:__("Active proctors"),size:4,icon:"taker",value:0},
activeTestTakers:{container:"active-test-takers",label:__("Active test-takers"),size:4,icon:"takers",value:0}};return Handlebars.registerPartial("ui-activity-widget-group",groupTpl),function(config){return config=config||{},component({update:function(data){var metricsWidget;for(metricsWidget in _.merge(this.config,data),this.config)this.config.hasOwnProperty(metricsWidget)&&$("."+this.config[metricsWidget].container,this.getElement()).text(this.config[metricsWidget].value)}},_defaults).setTemplate(componentTpl).init(config)}}),define("tpl!taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity",["handlebars"],function(
hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div>\n    <div class="col-4 dashboard-block">\n        <h4>\n            <span class="icon icon-play"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression(
"function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\n        </span>\n    </div>\n\n    <div class="col-2 dashboard-block">\n        <h4>\n            <span class="icon icon-play"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments
)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1
)+'\n        </span>\n    </div>\n\n    <div class="col-2 dashboard-block">\n        <h4>\n            <span class="icon icon-time"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.awaiting)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.awaiting)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression(
"function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.awaiting)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\n        </span>\n    </div>\n\n    <div class="col-2 dashboard-block">\n        <h4>\n            <span class="icon icon-continue"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.authorized)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(
stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.authorized)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.authorized)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\n        </span>\n    </div>\n\n    <div class="col-2 dashboard-block">\n        <h4>\n            <span class="icon icon-pause"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.paused
)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.paused)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.paused)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+"\n        </span>\n    </div>\n</div>"})}),define(
"taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity",["jquery","lodash","i18n","ui/component","tpl!taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity"],function($,_,__,component,tpl){"use strict";var _defaults={assessments:{awaiting:{container:"awaiting-assessments",label:__("Awaiting"),value:0},authorized:{container:"authorized-but-not-started-assessments",label:__("Authorized"),value:0},current:{container:"current-assessments",label:__("Total Current Assessments"),value:0},inProgress:{container:"in-progress-assessments",label:__("In Progress"),value:0},paused:{
container:"paused-assessments",label:__("Paused"),value:0}}};return function(config){return config=config||{},component({update:function(data){_.merge(this.config.assessments,data),_.each(this.config.assessments,function(val){$("."+val.container,this.getElement()).text(val.value)},this)}},_defaults).setTemplate(tpl).init(config)}}),define("tpl!taoProctoring/component/activityMonitoring/progressbar",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{},
'<div class="js-completed-assessments-refresh-bar refresh-bar">\n    <div class="js-refresh-bar-progress refresh-bar-progress"></div>\n</div>'})}),define("taoProctoring/component/activityMonitoring/activityGraph",["jquery","lodash","i18n","ui/component","util/url","c3","tpl!taoProctoring/component/activityMonitoring/progressbar","core/polling"],function($,_,__,component,url,c3,progressbarTpl,pollingFactory){"use strict";var _defaults={autoRefresh:0,autoRefreshBar:!1,transition:{duration:3e3},graphConfig:{padding:{bottom:0,left:35},data:{x:"time",xFormat:"%Y-%m-%d %H:%M:%S",mimeType:"json",type:"bar"},axis:{x:{type:"timeseries",tick:{format:"%H:%M"},label:{
position:"bottom center"}},y:{label:{position:"top"}}}}};function runRefreshProgressBar($refreshProgress,duration){duration/=1e3,$refreshProgress.css({"-webkit-transition":"width 0s","-moz-transition":"width 0s","-o-transition":"width 0s",transition:"width 0s",width:"0%"}),$refreshProgress.hide().show(),$refreshProgress.css({"-webkit-transition":"width "+duration+"s linear","-moz-transition":"width "+duration+"s linear","-o-transition":"width "+duration+"s linear",transition:"width "+duration+"s linear",width:"100%"})}return function(config){var chart,$refreshProgress,$progressbar,polling,initConfig=_.merge({},_defaults,config);return component({
refresh:function(newConfig){chart&&(initConfig=_.merge({},initConfig,newConfig),chart.internal.config.axis_x_tick_format=initConfig.graphConfig.axis.x.tick.format,chart.axis.labels({x:initConfig.graphConfig.axis.x.label.text}),chart.load(initConfig.graphConfig.data))}}).on("render",function(){chart=c3.generate(initConfig.graphConfig),initConfig.autoRefresh&&($progressbar=$(progressbarTpl()),$(initConfig.graphConfig.bindto).after($progressbar),$refreshProgress=$progressbar.find(".js-refresh-bar-progress"),initConfig.autoRefreshBar&&runRefreshProgressBar($refreshProgress,initConfig.autoRefresh),polling=pollingFactory({action:function(){chart.load(
initConfig.graphConfig.data),initConfig.autoRefreshBar&&runRefreshProgressBar($refreshProgress,initConfig.autoRefresh)},interval:initConfig.autoRefresh,autoStart:!0}))}).on("destroy",function(){polling&&polling.stop()}).init(initConfig)}}),define("taoProctoring/component/activityMonitoring/deliveriesList/deliveriesList",["jquery","i18n","util/url","ui/component","util/locale","ui/datatable"],function($,__,url,component,locale){"use strict";var _defaults={model:[{id:"label",label:__("Delivery"),sortable:!0},{id:__("Awaiting"),label:__("Awaiting"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Authorized"),label:__("Authorized"),
sortable:!0,transform:function(value){return value.toString()}},{id:__("Paused"),label:__("Paused"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Active"),label:__("Active"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Terminated"),label:__("Terminated"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Canceled"),label:__("Canceled"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Finished"),label:__("Finished"),sortable:!0,transform:function(value){return value.toString()}},{id:__("Last launch"),label:__("Last launch"),sortable:!0,transform:function(value){
...
"ui/cascadingComboBox","ui/bulkActionPopup","taoProctoring/component/activityMonitoring/userActivity/userActivity","taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity","taoProctoring/component/activityMonitoring/activityGraph","taoProctoring/component/activityMonitoring/deliveriesList/deliveriesList"],function($,d3,_,__,helpers,url,request,polling,feedback,cascadingComboBox,bulkActionPopup,userActivityFactory,currentAssessmentActivityFactory,activityGraphFactory,deliveriesListFactory){"use strict";var pauseMsg=__(
"Warning, you are about to pause all in progress tests. All test takers will be paused on or before the next heartbeat. Please provide a reason for this action.");return{start:function(){var activityGraph,assessmentActivityAutoRefreshInterval,completedAssessmentsAutoRefreshInterval,config,currentAssessmentActivity,deliveriesList,pauseReasonCategories,poll,userActivity,$container=$(".activity-dashboard");config=$container.data("config"),assessmentActivityAutoRefreshInterval=1e3*parseInt(config.assessment_activity_auto_refresh),completedAssessmentsAutoRefreshInterval=1e3*parseInt(config.completed_assessments_auto_refresh),userActivity=userActivityFactory(
config.userActivityWidgets).render($(".user-activity",$container)),currentAssessmentActivity=currentAssessmentActivityFactory().render($(".assessment-activity",$container)),activityGraph=activityGraphFactory({autoRefresh:Math.max(completedAssessmentsAutoRefreshInterval,assessmentActivityAutoRefreshInterval),autoRefreshBar:!0,graphConfig:{bindto:$(".js-completed-assessments",$container).selector,data:{url:url.route("completedAssessmentsData","Tools","taoProctoring")},axis:{x:{label:{text:__("Hours")}},y:{label:{text:__("Completed tests")},tick:{format:d3.format("d")}}},tooltip:{format:{name:function(){return __("Completed")}}},legend:{show:!1}}}).render(),$(
".js-activity-chart-interval",$container).on("change",function(){var interval=$(this).val();activityGraph.refresh({graphConfig:{data:{url:url.route("completedAssessmentsData","Tools","taoProctoring",{interval:interval})},axis:{x:{tick:{format:"day"===interval?"%H:%M":"%m-%d"},label:{text:__("day"===interval?"Hours":"Days")}}}}})}),deliveriesList=deliveriesListFactory().render($(".js-delivery-list")),poll=polling({action:function(){request(url.route("assessmentActivityData","Tools","taoProctoring")).then(function(data){var uaData={};data&&data.group_user_activity&&_.forEach(data.group_user_activity,function(v,k){uaData[$.camelCase(k.replace(/_/g,"-"))]={
value:v}}),userActivity.update(uaData),currentAssessmentActivity.update({awaiting:{value:data&&data.awaiting_assessments},authorized:{value:data&&data.authorized_but_not_started_assessments},current:{value:data&&data.total_current_assessments},inProgress:{value:data&&data.in_progress_assessments},paused:{value:data&&data.paused_assessments}}),deliveriesList.update()}).catch(function(err){feedback().error(err.message),poll.stop()})}}).next().stop(),assessmentActivityAutoRefreshInterval&&(poll.setInterval(assessmentActivityAutoRefreshInterval),poll.start()),pauseReasonCategories=$(".js-pause-active-executions-container").data("reasoncategories"),$(".js-pause",
$container).on("click",function(){bulkActionPopup({renderTo:$(".js-pause-active-executions-container",$container),actionName:pauseMsg,reason:!0,allowedResources:[],reasonRequired:!0,categoriesSelector:cascadingComboBox(pauseReasonCategories.pause)}).on("ok",function(reason){!function(reason){request(url.route("pauseActiveExecutions","Tools","taoProctoring"),{reason:reason},"POST").then(function(data){helpers.loaded(),feedback().success(data.message)}).catch(function(err){helpers.loaded(),feedback().error(err.message)})}(reason)})})}}}),define("taoProctoring/helper/textConverter",["jquery","lodash","core/format","core/promise","util/url"],function($,_,format,
Promise,url){"use strict";var pendingPromise,labels=null,proctoringLabels={get:function(message){null==labels[message]&&console.log(message);var localized=labels[message]?labels[message]:message;return 1<arguments.length&&(message=localized,localized=format.apply(null,arguments)),localized}};return function(){return pendingPromise||(pendingPromise=new Promise(function(resolve,reject){$.ajax({url:url.route("getAll","TextConverter","taoProctoring"),type:"POST",dataType:"json"}).done(function(data){labels=data.translations,resolve(proctoringLabels)}).fail(reject)})),pendingPromise}}),define("taoProctoring/loader/taoProctoring.bundle",function(){}),
