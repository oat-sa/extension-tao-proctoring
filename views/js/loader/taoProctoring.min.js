...
sortBy:data.sortBy,sortOrder:data.sortOrder},data.set).on("loading",function(){loadingBar.start()}).on("loaded",function(){loadingBar.stop()}).on("error",function(err){appController.onError(err)}).render(container.find(".list"));return data.monitoringUrl&&(monitoringUrl=data.monitoringUrl),new Promise(function(resolve,reject){dateRangeFactory(container.find(".panel"),{resetButton:{enable:!1},applyButton:{enable:!0,label:__("Filter"),title:__("Filter by the selected dates")},startPicker:{setup:"date",format:dateFormat,field:{value:data.periodStart,name:"periodStart"}},endPicker:{setup:"date",format:dateFormat,field:{value:data.periodEnd,name:"periodEnd"}}}
).on("ready",resolve).on("error",reject).on("submit reset",function(){historyTable.refresh({periodStart:this.getStart(),periodEnd:this.getEnd()})})}).then(function(){buttonFactory({id:"back",type:"info",label:__("Back to sessions"),cls:"back-button",renderTo:container.find(".panel")}).on("click",function(){monitoringUrl?appController.getRouter().redirect(monitoringUrl):history.go(-1)})})})}).catch(function(err){appController.onError(err),loadingBar.stop()})}}}),define("taoProctoring/controller/routes",{Reporting:{actions:{index:"controller/Reporting/history"}},Irregularity:{actions:{index:"controller/Irregularity/index"}},DeliverySelection:{actions:{
index:"controller/Delivery/index"}},Monitor:{actions:{index:"controller/Delivery/monitoring"}},Tools:{css:"tools",actions:{assessmentActivity:"controller/Tools/assessmentActivity"}}}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="col-',buffer+=escapeExpression((helper=helpers.size)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(
helper=depth0&&depth0.size)?helper.call(depth0,{hash:{},data:data}):helper)+' dashboard-block">\n        <span class="dashboard-block-number ',buffer+=escapeExpression((helper=helpers.container)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.container)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n            ',buffer+=escapeExpression((helper=helpers.value)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.value)?helper.call(depth0,{hash:{},data:data}):helper)+'\n        </span>\n    <h3>\n        <span class="icon icon-test-',buffer+=escapeExpression((helper=helpers.icon)?helper.call(
depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.icon)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\n        ',buffer+=escapeExpression((helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,{hash:{},data:data}):helper)+"\n    </h3>\n</div>"})}),define("tpl!taoProctoring/component/activityMonitoring/userActivity/userActivity",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),
data=data||{};var stack1,buffer="",self=this;return buffer+="<div>\n    ",((stack1=helpers.each.call(depth0,depth0,{hash:{},inverse:self.noop,fn:self.program(1,function(depth0,data){var stack1,buffer="";return buffer+="\n    ",((stack1=self.invokePartial(partials["ui-activity-widget-group"],"ui-activity-widget-group",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+="\n    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n</div>"})}),define("taoProctoring/component/activityMonitoring/userActivity/userActivity",["jquery","lodash","i18n","ui/component","handlebars",
"tpl!taoProctoring/component/activityMonitoring/userActivity/userActivityBlock","tpl!taoProctoring/component/activityMonitoring/userActivity/userActivity"],function($,_,__,component,Handlebars,groupTpl,componentTpl){"use strict";var _defaults={activeProctors:{container:"active-proctors",label:__("Active proctors"),size:4,icon:"taker",value:0},activeTestTakers:{container:"active-test-takers",label:__("Active test-takers"),size:4,icon:"takers",value:0}};return Handlebars.registerPartial("ui-activity-widget-group",groupTpl),function(config){return config=config||{},component({update:function(data){var metricsWidget;for(metricsWidget in _.merge(this.config,data)
,this.config)this.config.hasOwnProperty(metricsWidget)&&$("."+this.config[metricsWidget].container,this.getElement()).text(this.config[metricsWidget].value)}},_defaults).setTemplate(componentTpl).init(config)}}),define("tpl!taoProctoring/component/activityMonitoring/currentAssessmentActivity/currentAssessmentActivity",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",escapeExpression=this.escapeExpression
;return buffer+='<div>\n    <div class="col-4 dashboard-block">\n        <h4>\n            <span class="icon icon-play"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression("function"==typeof(
stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.current)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\n        </span>\n    </div>\n\n    <div class="col-2 dashboard-block">\n        <h4>\n            <span class="icon icon-play"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.label)?stack1.apply(depth0):stack1)+'\n        </h4>\n        <span class="dashboard-block-number '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(
stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.container)?stack1.apply(depth0):stack1)+'">\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.inProgress)||!1===stack1?stack1:stack1.value)?stack1.apply(depth0):stack1)+'\n        </span>\n    </div>\n\n    <div class="col-2 dashboard-block">\n        <h4>\n            <span class="icon icon-time"></span>\n            '+escapeExpression("function"==typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.assessments)||!1===stack1?stack1:stack1.awaiting
