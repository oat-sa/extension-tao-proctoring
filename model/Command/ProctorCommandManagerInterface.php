...
interface ProctorCommandManagerInterface
{
    const SERVICE_ID = 'taoProctoring/proctorCommandManager';
    /**
    ...
    /**
     * @param ProctorCommand $command
     * @return mixed
     */
    public function executeCommand(ProctorCommand $command);
